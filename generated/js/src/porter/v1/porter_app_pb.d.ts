 ...
 *
 * @generated from message porter.v1.PorterAppRevision
 */
export declare class PorterAppRevision extends Message<PorterAppRevision> {
  /**
  ...
  constructor(data?: PartialMessage<PorterAppRevision>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "porter.v1.PorterAppRevision";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PorterAppRevision;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PorterAppRevision;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PorterAppRevision;

  static equals(a: PorterAppRevision | PlainMessage<PorterAppRevision> | undefined, b: PorterAppRevision | PlainMessage<PorterAppRevision> | undefined): boolean;
}
