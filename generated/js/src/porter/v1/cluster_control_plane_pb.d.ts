 ...
 */
export declare class ECRStatusRequest extends Message<ECRStatusRequest> {
  /**
  ...
  constructor(data?: PartialMessage<ECRStatusRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "porter.v1.ECRStatusRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ECRStatusRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ECRStatusRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ECRStatusRequest;

  static equals(a: ECRStatusRequest | PlainMessage<ECRStatusRequest> | undefined, b: ECRStatusRequest | PlainMessage<ECRStatusRequest> | undefined): boolean;
}
 ...
 */
export declare class ECRStatusResponse extends Message<ECRStatusResponse> {
  /**
   * scanned is a boolean containing whether scanning is properly enabled or not
   *
   * @generated from field: bool scanned = 1;
   */
  scanned: boolean;

  constructor(data?: PartialMessage<ECRStatusResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "porter.v1.ECRStatusResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ECRStatusResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ECRStatusResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ECRStatusResponse;

  static equals(a: ECRStatusResponse | PlainMessage<ECRStatusResponse> | undefined, b: ECRStatusResponse | PlainMessage<ECRStatusResponse> | undefined): boolean;
}
