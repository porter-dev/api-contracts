 ...
 */
export const Datadog = proto3.makeMessageType(
  "porter.v1.Datadog",
  () => [
 ...
 */
export const Mezmo = proto3.makeMessageType(
  "porter.v1.Mezmo",
  () => [
 ...
 */
export const MetabaseDatastore = proto3.makeMessageType(
 ...
 */
export const Metabase = proto3.makeMessageType(
  "porter.v1.Metabase",
  () => [
 ...
 */
export const Newrelic = proto3.makeMessageType(
  "porter.v1.Newrelic",
  () => [
 ...
 */
export const Tailscale = proto3.makeMessageType(
  "porter.v1.Tailscale",
  () => [
 ...
 */
export const Quivr = proto3.makeMessageType(
  "porter.v1.Quivr",
  () => [
    { no: 1, name: "domains", kind: "message", T: Domain, repeated: true },
 ...
 */
export const Deepgram = proto3.makeMessageType(
  "porter.v1.Deepgram",
  () => [
