...
export const AppEventWebhook = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "webhook_url", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
    { no: 3, name: "app_event_type", kind: "enum", T: proto3.getEnumType(WebhookAppEventType) },
    { no: 4, name: "app_event_status", kind: "enum", T: proto3.getEnumType(WebhookAppEventStatus) },
  ],
);
