 ...
 */
export const MachineTypesRequest = proto3.makeMessageType(
 ...
 */
export const MachineTypesResponse = proto3.makeMessageType(
 ...
 */
export const DeletePorterCloudClusterRequest = proto3.makeMessageType(
 ...
 */
export const DeletePorterCloudClusterResponse = proto3.makeMessageType(
 ...
 */
export const AddonRequest = proto3.makeMessageType(
 ...
 */
export const AddonResponse = proto3.makeMessageType(
 ...
 */
export const UpdateAddonRequest = proto3.makeMessageType(
 ...
 */
export const UpdateAddonResponse = proto3.makeMessageType(
 ...
 */
export const DeleteAddonRequest = proto3.makeMessageType(
 ...
 */
export const DeleteAddonResponse = proto3.makeMessageType(
 ...
 */
export const ListTemplatesRequest = proto3.makeMessageType(
  "porter.v1.ListTemplatesRequest",
  () => [
    { no: 1, name: "project_id", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 2, name: "cluster_id", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
  ],
 ...
 */
export const ListTemplatesResponse = proto3.makeMessageType(
  "porter.v1.ListTemplatesResponse",
  () => [
    { no: 1, name: "environment_templates", kind: "message", T: Environment, repeated: true },
  ],
);
 ...
 */
export const CancelJobRunRequest = proto3.makeMessageType(
 ...
 */
export const CancelJobRunResponse = proto3.makeMessageType(
 ...
 */
export const RecordPrometheusAlertRequest = proto3.makeMessageType(
 ...
 */
export const RecordPrometheusAlertResponse = proto3.makeMessageType(
 ...
 */
export const ConnectHostedProjectRequest = proto3.makeMessageType(
 ...
 */
export const ConnectHostedProjectResponse = proto3.makeMessageType(
 ...
 */
export const DeleteDatastoreRequest = proto3.makeMessageType(
 ...
 */
export const DeleteDatastoreResponse = proto3.makeMessageType(
 ...
 */
export const UserNodeGroupsRequest = proto3.makeMessageType(
 ...
 */
export const UserNodeGroupsResponse = proto3.makeMessageType(
 ...
 */
export const DeleteUserNodeGroupRequest = proto3.makeMessageType(
 ...
 */
export const DeleteUserNodeGroupResponse = proto3.makeMessageType(
 ...
 */
export const SystemStatusHistoryRequest = proto3.makeMessageType(
 ...
 */
export const SystemStatusHistoryResponse = proto3.makeMessageType(
 ...
 */
export const AppEventWebhooksRequest = proto3.makeMessageType(
 ...
 */
export const AppEventWebhooksResponse = proto3.makeMessageType(
 ...
 */
export const UpdateAppEventWebhooksRequest = proto3.makeMessageType(
  "porter.v1.UpdateAppEventWebhooksRequest",
  () => [
    { no: 1, name: "project_id", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 2, name: "deployment_target_identifier", kind: "message", T: DeploymentTargetIdentifier },
    { no: 3, name: "app_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 4, name: "app_event_webhooks", kind: "message", T: AppEventWebhook, repeated: true },
  ],
);
 ...
 */
export const UpdateAppEventWebhooksResponse = proto3.makeMessageType(
  "porter.v1.UpdateAppEventWebhooksResponse",
  [],
);
