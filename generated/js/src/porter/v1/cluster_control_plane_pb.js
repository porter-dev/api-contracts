...
import { ClusterStatusHistory, ServiceStatusHistory } from "./system_service_pb.js";
...
export const SystemStatusHistoryResponse = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "system_service_status_histories", kind: "message", T: ServiceStatusHistory, repeated: true },
  ],
);
