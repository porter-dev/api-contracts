...
export const EnumComplianceCheckStatus = /*@__PURE__*/ proto3.makeEnum(
  ...
  [
    ...
    {no: 4, name: "ENUM_COMPLIANCE_CHECK_STATUS_PENDING", localName: "PENDING"},
  ],
);
...
export const ContractComplianceCheckGroup = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "resource_statuses", kind: "message", T: ResourceComplianceStatus, repeated: true },
  ],
);
 ...
 */
export const ResourceComplianceStatus = /*@__PURE__*/ proto3.makeMessageType(
  "porter.v1.ResourceComplianceStatus",
  () => [
...
export const VendorComplianceCheck = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "resource_statuses", kind: "message", T: ResourceComplianceStatus, repeated: true },
  ],
);
