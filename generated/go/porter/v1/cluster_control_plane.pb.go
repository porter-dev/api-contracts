...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x6c,
	0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x59, 0x0a, 0x15, 0x45, 0x4b, 0x53, 0x42, 0x65,
	...
	0x18, 0x01, 0x2a, 0xab, 0x01, 0x0a, 0x13, 0x45, 0x6e, 0x75, 0x6d, 0x50, 0x72, 0x65, 0x64, 0x65,
	...
	0x4b, 0x5f, 0x50, 0x52, 0x45, 0x44, 0x45, 0x50, 0x4c, 0x4f, 0x59, 0x10, 0x03, 0x32, 0x81, 0x17,
	0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x50, 0x6c, 0x61, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x87, 0x01, 0x0a,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 58)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*EKSBearerTokenRequest)(nil),               // 47: porter.v1.EKSBearerTokenRequest
	(*EKSBearerTokenResponse)(nil),              // 48: porter.v1.EKSBearerTokenResponse
	(*CertificateAuthorityDataRequest)(nil),     // 49: porter.v1.CertificateAuthorityDataRequest
	(*CertificateAuthorityDataResponse)(nil),    // 50: porter.v1.CertificateAuthorityDataResponse
	(*AssumeRoleChainTargetsRequest)(nil),       // 51: porter.v1.AssumeRoleChainTargetsRequest
	(*AssumeRoleChainTargetsResponse)(nil),      // 52: porter.v1.AssumeRoleChainTargetsResponse
	(*ECRTokenForRegistryRequest)(nil),          // 53: porter.v1.ECRTokenForRegistryRequest
	(*ECRTokenForRegistryResponse)(nil),         // 54: porter.v1.ECRTokenForRegistryResponse
	(*AssumeRoleCredentialsRequest)(nil),        // 55: porter.v1.AssumeRoleCredentialsRequest
	(*AssumeRoleCredentialsResponse)(nil),       // 56: porter.v1.AssumeRoleCredentialsResponse
	(*DockerConfigFileForRegistryRequest)(nil),  // 57: porter.v1.DockerConfigFileForRegistryRequest
	(*DockerConfigFileForRegistryResponse)(nil), // 58: porter.v1.DockerConfigFileForRegistryResponse
	nil,                           // 59: porter.v1.PreflightCheckResponse.PreflightChecksEntry
	(EnumCloudProvider)(0),        // 60: porter.v1.EnumCloudProvider
	(*GKEPreflightValues)(nil),    // 61: porter.v1.GKEPreflightValues
	(*EKSPreflightValues)(nil),    // 62: porter.v1.EKSPreflightValues
	(*Contract)(nil),              // 63: porter.v1.Contract
	(*ContractRevision)(nil),      // 64: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil), // 65: google.protobuf.Timestamp
	(*PorterApp)(nil),             // 66: porter.v1.PorterApp
	(*Deletions)(nil),             // 67: porter.v1.Deletions
	(*AssumeRoleChainLink)(nil),   // 68: porter.v1.AssumeRoleChainLink
	(*Error)(nil),                 // 69: porter.v1.Error
	(*UpdateCloudProviderCredentialsRequest)(nil),  // 70: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil), // 71: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	60, // 0: porter.v1.PreflightCheckRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	61, // 1: porter.v1.PreflightCheckRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	62, // 2: porter.v1.PreflightCheckRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	59, // 3: porter.v1.PreflightCheckResponse.preflight_checks:type_name -> porter.v1.PreflightCheckResponse.PreflightChecksEntry
	63, // 4: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	64, // 5: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	64, // 6: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	...
	65, // 9: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	64, // 10: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	66, // 11: porter.v1.ValidatePorterAppRequest.app:type_name -> porter.v1.PorterApp
	67, // 12: porter.v1.ValidatePorterAppRequest.deletions:type_name -> porter.v1.Deletions
	66, // 13: porter.v1.ValidatePorterAppResponse.app:type_name -> porter.v1.PorterApp
	66, // 14: porter.v1.ApplyPorterAppRequest.app:type_name -> porter.v1.PorterApp
	1,  // 15: porter.v1.ApplyPorterAppResponse.cli_action:type_name -> porter.v1.EnumCLIAction
	66, // 16: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	65, // 17: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	65, // 18: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	...
	68, // 23: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	65, // 24: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	69, // 25: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	70, // 26: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	...
	57, // 48: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	53, // 49: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	55, // 50: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	51, // 51: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	49, // 52: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	47, // 53: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	71, // 54: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	5,  // 55: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	3,  // 56: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	7,  // 57: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	9,  // 58: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	11, // 59: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	13, // 60: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	27, // 61: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	15, // 62: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	17, // 63: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	25, // 64: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	19, // 65: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	22, // 66: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	29, // 67: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	31, // 68: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	33, // 69: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	35, // 70: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	38, // 71: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	40, // 72: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	42, // 73: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	44, // 74: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	46, // 75: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	58, // 76: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	54, // 77: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	56, // 78: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	52, // 79: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	50, // 80: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	48, // 81: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
