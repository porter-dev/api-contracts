...
type AssumeRoleChainRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AssumeRoleChainRequest) Reset() {
	*x = AssumeRoleChainRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *AssumeRoleChainRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssumeRoleChainRequest) ProtoMessage() {}

func (x *AssumeRoleChainRequest) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_cluster_control_plane_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssumeRoleChainRequest.ProtoReflect.Descriptor instead.
func (*AssumeRoleChainRequest) Descriptor() ([]byte, []int) {
	return file_porter_v1_cluster_control_plane_proto_rawDescGZIP(), []int{2}
}

func (x *AssumeRoleChainRequest) GetProjectId() int64 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *AssumeRoleChainRequest) GetClusterId() int64 {
	if x != nil {
		return x.ClusterId
	}
	return 0
...
type AssumeRoleChainResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AssumeRoleChainResponse) Reset() {
	*x = AssumeRoleChainResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *AssumeRoleChainResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AssumeRoleChainResponse) ProtoMessage() {}

func (x *AssumeRoleChainResponse) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_cluster_control_plane_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AssumeRoleChainResponse.ProtoReflect.Descriptor instead.
func (*AssumeRoleChainResponse) Descriptor() ([]byte, []int) {
	return file_porter_v1_cluster_control_plane_proto_rawDescGZIP(), []int{3}
}

func (x *AssumeRoleChainResponse) GetChainLinks() []*AssumeRoleChainLink {
	if x != nil {
		return x.ChainLinks
	}
	return nil
...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x41, 0x72, 0x6e, 0x22, 0x56, 0x0a, 0x16, 0x41, 0x73, 0x73,
	...
	0x64, 0x22, 0x5a, 0x0a, 0x17, 0x41, 0x73, 0x73, 0x75, 0x6d, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x43,
	0x68, 0x61, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0b,
	...
	0x6b, 0x52, 0x0a, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x4c, 0x69, 0x6e, 0x6b, 0x73, 0x32, 0xe6, 0x01,
	0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x50, 0x6c, 0x61, 0x6e, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x6c, 0x0a, 0x15,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5a, 0x0a, 0x0f, 0x41, 0x73,
	0x73, 0x75, 0x6d, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x12, 0x21, 0x2e,
	...
	0x1a, 0x22, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x73, 0x73,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*AssumeRoleChainRequest)(nil),        // 2: porter.v1.AssumeRoleChainRequest
	(*AssumeRoleChainResponse)(nil),       // 3: porter.v1.AssumeRoleChainResponse
	(*AssumeRoleChainLink)(nil),           // 4: porter.v1.AssumeRoleChainLink
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	4, // 0: porter.v1.AssumeRoleChainResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	0, // 1: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:input_type -> porter.v1.CreateAssumeRoleChainRequest
	2, // 2: porter.v1.ClusterControlPlaneService.AssumeRoleChain:input_type -> porter.v1.AssumeRoleChainRequest
	1, // 3: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	3, // 4: porter.v1.ClusterControlPlaneService.AssumeRoleChain:output_type -> porter.v1.AssumeRoleChainResponse
...
func file_porter_v1_cluster_control_plane_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_porter_v1_cluster_control_plane_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssumeRoleChainRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_porter_v1_cluster_control_plane_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssumeRoleChainResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
