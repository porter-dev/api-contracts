...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x01, 0x0a, 0x1a, 0x51,
	...
	0x22, 0x1d, 0x0a, 0x1b, 0x51, 0x75, 0x6f, 0x74, 0x61, 0x50, 0x72, 0x65, 0x66, 0x6c, 0x69, 0x67,
	...
	0x67, 0x65, 0x73, 0x22, 0x42, 0x0a, 0x05, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12, 0x27, 0x0a, 0x0f,
	...
	0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x22, 0x5b, 0x0a, 0x17, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x73, 0x65, 0x36, 0x34, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x22, 0x59, 0x0a, 0x15,
	...
	0x69, 0x6c, 0x65, 0x3a, 0x02, 0x18, 0x01, 0x32, 0xad, 0x0f, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*SaveAzureCredentialsRequest)(nil),            // 4: porter.v1.SaveAzureCredentialsRequest
	(*SaveAzureCredentialsResponse)(nil),           // 5: porter.v1.SaveAzureCredentialsResponse
	(*KubeConfigForClusterRequest)(nil),            // 6: porter.v1.KubeConfigForClusterRequest
	(*KubeConfigForClusterResponse)(nil),           // 7: porter.v1.KubeConfigForClusterResponse
	(*UpdateContractRequest)(nil),                  // 8: porter.v1.UpdateContractRequest
	(*UpdateContractResponse)(nil),                 // 9: porter.v1.UpdateContractResponse
	(*ClusterStatusRequest)(nil),                   // 10: porter.v1.ClusterStatusRequest
	(*ClusterStatusResponse)(nil),                  // 11: porter.v1.ClusterStatusResponse
	(*DeleteClusterRequest)(nil),                   // 12: porter.v1.DeleteClusterRequest
	(*DeleteClusterResponse)(nil),                  // 13: porter.v1.DeleteClusterResponse
	(*ListRepositoriesForRegistryRequest)(nil),     // 14: porter.v1.ListRepositoriesForRegistryRequest
	(*ListRepositoriesForRegistryResponse)(nil),    // 15: porter.v1.ListRepositoriesForRegistryResponse
	(*Repository)(nil),                             // 16: porter.v1.Repository
	(*ListImagesForRepositoryRequest)(nil),         // 17: porter.v1.ListImagesForRepositoryRequest
	(*ListImagesForRepositoryResponse)(nil),        // 18: porter.v1.ListImagesForRepositoryResponse
	(*Image)(nil),                                  // 19: porter.v1.Image
	(*TokenForRegistryRequest)(nil),                // 20: porter.v1.TokenForRegistryRequest
	(*TokenForRegistryResponse)(nil),               // 21: porter.v1.TokenForRegistryResponse
	(*ReadContractRequest)(nil),                    // 22: porter.v1.ReadContractRequest
	(*ReadContractResponse)(nil),                   // 23: porter.v1.ReadContractResponse
	(*EKSBearerTokenRequest)(nil),                  // 24: porter.v1.EKSBearerTokenRequest
	(*EKSBearerTokenResponse)(nil),                 // 25: porter.v1.EKSBearerTokenResponse
	(*CertificateAuthorityDataRequest)(nil),        // 26: porter.v1.CertificateAuthorityDataRequest
	(*CertificateAuthorityDataResponse)(nil),       // 27: porter.v1.CertificateAuthorityDataResponse
	(*AssumeRoleChainTargetsRequest)(nil),          // 28: porter.v1.AssumeRoleChainTargetsRequest
	(*AssumeRoleChainTargetsResponse)(nil),         // 29: porter.v1.AssumeRoleChainTargetsResponse
	(*ECRTokenForRegistryRequest)(nil),             // 30: porter.v1.ECRTokenForRegistryRequest
	(*ECRTokenForRegistryResponse)(nil),            // 31: porter.v1.ECRTokenForRegistryResponse
	(*AssumeRoleCredentialsRequest)(nil),           // 32: porter.v1.AssumeRoleCredentialsRequest
	(*AssumeRoleCredentialsResponse)(nil),          // 33: porter.v1.AssumeRoleCredentialsResponse
	(*DockerConfigFileForRegistryRequest)(nil),     // 34: porter.v1.DockerConfigFileForRegistryRequest
	(*DockerConfigFileForRegistryResponse)(nil),    // 35: porter.v1.DockerConfigFileForRegistryResponse
	(*Contract)(nil),                               // 36: porter.v1.Contract
	(*ContractRevision)(nil),                       // 37: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil),                  // 38: google.protobuf.Timestamp
	(*AssumeRoleChainLink)(nil),                    // 39: porter.v1.AssumeRoleChainLink
	(*UpdateCloudProviderCredentialsRequest)(nil),  // 40: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil), // 41: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	36, // 0: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	37, // 1: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	37, // 2: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	16, // 3: porter.v1.ListRepositoriesForRegistryResponse.repositories:type_name -> porter.v1.Repository
	19, // 4: porter.v1.ListImagesForRepositoryResponse.images:type_name -> porter.v1.Image
	38, // 5: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	37, // 6: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	39, // 7: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	38, // 8: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	40, // 9: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	0,  // 10: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:input_type -> porter.v1.QuotaPreflightCheckRequest
	2,  // 11: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:input_type -> porter.v1.CreateAssumeRoleChainRequest
	4,  // 12: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:input_type -> porter.v1.SaveAzureCredentialsRequest
	6,  // 13: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:input_type -> porter.v1.KubeConfigForClusterRequest
	8,  // 14: porter.v1.ClusterControlPlaneService.UpdateContract:input_type -> porter.v1.UpdateContractRequest
	22, // 15: porter.v1.ClusterControlPlaneService.ReadContract:input_type -> porter.v1.ReadContractRequest
	10, // 16: porter.v1.ClusterControlPlaneService.ClusterStatus:input_type -> porter.v1.ClusterStatusRequest
	12, // 17: porter.v1.ClusterControlPlaneService.DeleteCluster:input_type -> porter.v1.DeleteClusterRequest
	20, // 18: porter.v1.ClusterControlPlaneService.TokenForRegistry:input_type -> porter.v1.TokenForRegistryRequest
	14, // 19: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:input_type -> porter.v1.ListRepositoriesForRegistryRequest
	17, // 20: porter.v1.ClusterControlPlaneService.ListImagesForRepository:input_type -> porter.v1.ListImagesForRepositoryRequest
	34, // 21: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	30, // 22: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	32, // 23: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	28, // 24: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	26, // 25: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	24, // 26: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	41, // 27: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	1,  // 28: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	3,  // 29: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	5,  // 30: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	7,  // 31: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	9,  // 32: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	23, // 33: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	11, // 34: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	13, // 35: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	21, // 36: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	15, // 37: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	18, // 38: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	35, // 39: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	31, // 40: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	33, // 41: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	29, // 42: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	27, // 43: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	25, // 44: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
