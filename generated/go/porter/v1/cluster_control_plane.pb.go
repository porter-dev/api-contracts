...
type ConnectHostedProjectRequest struct {
	...
	ProjectId     int64 `protobuf:"varint,1,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"`
	HostProjectId int64 `protobuf:"varint,2,opt,name=host_project_id,json=hostProjectId,proto3" json:"host_project_id,omitempty"`
	HostClusterId int64 `protobuf:"varint,3,opt,name=host_cluster_id,json=hostClusterId,proto3" json:"host_cluster_id,omitempty"`
}
...
func (x *ConnectHostedProjectRequest) GetHostProjectId() int64 {
	if x != nil {
...
func (x *ConnectHostedProjectRequest) GetHostClusterId() int64 {
	if x != nil {
...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x0a, 0x6c, 0x69, 0x6e, 0x6b, 0x65, 0x64, 0x41, 0x70, 0x70, 0x73, 0x22, 0x8c,
	0x01, 0x0a, 0x1b, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x48, 0x6f, 0x73, 0x74, 0x65, 0x64,
	...
	0x0f, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x68, 0x6f, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x6a,
	0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0f, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x63, 0x6c,
	0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d,
	0x68, 0x6f, 0x73, 0x74, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x3d, 0x0a,
	...
	0x03, 0x52, 0x09, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0x59, 0x0a, 0x15,
	...
	0x32, 0xf4, 0x36, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 148)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*EKSBearerTokenRequest)(nil),                       // 130: porter.v1.EKSBearerTokenRequest
	(*EKSBearerTokenResponse)(nil),                      // 131: porter.v1.EKSBearerTokenResponse
	(*CertificateAuthorityDataRequest)(nil),             // 132: porter.v1.CertificateAuthorityDataRequest
	(*CertificateAuthorityDataResponse)(nil),            // 133: porter.v1.CertificateAuthorityDataResponse
	(*AssumeRoleChainTargetsRequest)(nil),               // 134: porter.v1.AssumeRoleChainTargetsRequest
	(*AssumeRoleChainTargetsResponse)(nil),              // 135: porter.v1.AssumeRoleChainTargetsResponse
	(*ECRTokenForRegistryRequest)(nil),                  // 136: porter.v1.ECRTokenForRegistryRequest
	(*ECRTokenForRegistryResponse)(nil),                 // 137: porter.v1.ECRTokenForRegistryResponse
	(*AssumeRoleCredentialsRequest)(nil),                // 138: porter.v1.AssumeRoleCredentialsRequest
	(*AssumeRoleCredentialsResponse)(nil),               // 139: porter.v1.AssumeRoleCredentialsResponse
	(*DockerConfigFileForRegistryRequest)(nil),          // 140: porter.v1.DockerConfigFileForRegistryRequest
	(*DockerConfigFileForRegistryResponse)(nil),         // 141: porter.v1.DockerConfigFileForRegistryResponse
	(*ClusterNetworkSettingsRequest)(nil),               // 142: porter.v1.ClusterNetworkSettingsRequest
	(*ClusterNetworkSettingsResponse)(nil),              // 143: porter.v1.ClusterNetworkSettingsResponse
	(*ListDatastoresRequest)(nil),                       // 144: porter.v1.ListDatastoresRequest
	(*ListDatastoresResponse)(nil),                      // 145: porter.v1.ListDatastoresResponse
	(*DatastoreStatusRequest)(nil),                      // 146: porter.v1.DatastoreStatusRequest
	(*DatastoreStatusResponse)(nil),                     // 147: porter.v1.DatastoreStatusResponse
	(*Datastore)(nil),                                   // 148: porter.v1.Datastore
	(*DatastoreMetadata)(nil),                           // 149: porter.v1.DatastoreMetadata
	(*RegistryStatusRequest)(nil),                       // 150: porter.v1.RegistryStatusRequest
	(*RegistryStatusResponse)(nil),                      // 151: porter.v1.RegistryStatusResponse
	(*SharedNetworkSettingsRequest)(nil),                // 152: porter.v1.SharedNetworkSettingsRequest
	(*SharedNetworkSettingsResponse)(nil),               // 153: porter.v1.SharedNetworkSettingsResponse
	nil,                                                 // 154: porter.v1.PreflightCheckResponse.PreflightChecksEntry
	(EnumCloudProvider)(0),                              // 155: porter.v1.EnumCloudProvider
	(*GKEPreflightValues)(nil),                          // 156: porter.v1.GKEPreflightValues
	(*EKSPreflightValues)(nil),                          // 157: porter.v1.EKSPreflightValues
	(*Error)(nil),                                       // 158: porter.v1.Error
	(*Contract)(nil),                                    // 159: porter.v1.Contract
	(*ContractRevision)(nil),                            // 160: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil),                       // 161: google.protobuf.Timestamp
	(*PorterApp)(nil),                                   // 162: porter.v1.PorterApp
	(*Deletions)(nil),                                   // 163: porter.v1.Deletions
	(*DeploymentTargetIdentifier)(nil),                  // 164: porter.v1.DeploymentTargetIdentifier
	(*EnvGroupVariables)(nil),                           // 165: porter.v1.EnvGroupVariables
	(*Addon)(nil),                                       // 166: porter.v1.Addon
	(EnumAppRevisionStatus)(0),                          // 167: porter.v1.EnumAppRevisionStatus
	(*AppImage)(nil),                                    // 168: porter.v1.AppImage
	(*DeploymentTarget)(nil),                            // 169: porter.v1.DeploymentTarget
	(*EnvGroup)(nil),                                    // 170: porter.v1.EnvGroup
	(*Build)(nil),                                       // 171: porter.v1.Build
	(EnumEnvGroupProviderType)(0),                       // 172: porter.v1.EnumEnvGroupProviderType
	(*AssumeRoleChainLink)(nil),                         // 173: porter.v1.AssumeRoleChainLink
	(*AWSVpc)(nil),                                      // 174: porter.v1.AWSVpc
	(*UpdateCloudProviderCredentialsRequest)(nil),       // 175: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil),      // 176: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	155, // 0: porter.v1.QuotaIncreaseRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	2,   // 1: porter.v1.QuotaIncreaseRequest.quota_increases:type_name -> porter.v1.EnumQuotaIncrease
	156, // 2: porter.v1.QuotaIncreaseRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	157, // 3: porter.v1.QuotaIncreaseRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	158, // 4: porter.v1.QuotaIncreaseResponse.error:type_name -> porter.v1.Error
	155, // 5: porter.v1.PreflightCheckRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	156, // 6: porter.v1.PreflightCheckRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	157, // 7: porter.v1.PreflightCheckRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	159, // 8: porter.v1.PreflightCheckRequest.contract:type_name -> porter.v1.Contract
	154, // 9: porter.v1.PreflightCheckResponse.preflight_checks:type_name -> porter.v1.PreflightCheckResponse.PreflightChecksEntry
	159, // 10: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	160, // 11: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	160, // 12: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	...
	161, // 15: porter.v1.Image.updated_at:type_name -> google.protobuf.Timestamp
	32,  // 16: porter.v1.ImageInfo.artifacts:type_name -> porter.v1.ImageArtifact
	161, // 17: porter.v1.ImageArtifact.updated_at:type_name -> google.protobuf.Timestamp
	161, // 18: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	160, // 19: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	162, // 20: porter.v1.ValidatePorterAppRequest.app:type_name -> porter.v1.PorterApp
	163, // 21: porter.v1.ValidatePorterAppRequest.deletions:type_name -> porter.v1.Deletions
	162, // 22: porter.v1.ValidatePorterAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	164, // 23: porter.v1.ValidatePorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	162, // 24: porter.v1.ValidatePorterAppResponse.app:type_name -> porter.v1.PorterApp
	162, // 25: porter.v1.ApplyPorterAppRequest.app:type_name -> porter.v1.PorterApp
	165, // 26: porter.v1.ApplyPorterAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	164, // 27: porter.v1.ApplyPorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	3,   // 28: porter.v1.ApplyPorterAppResponse.cli_action:type_name -> porter.v1.EnumCLIAction
	164, // 29: porter.v1.UpdateAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	162, // 30: porter.v1.UpdateAppRequest.app:type_name -> porter.v1.PorterApp
	165, // 31: porter.v1.UpdateAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	163, // 32: porter.v1.UpdateAppRequest.deletions:type_name -> porter.v1.Deletions
	162, // 33: porter.v1.UpdateAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	166, // 34: porter.v1.UpdateAppRequest.addons:type_name -> porter.v1.Addon
	166, // 35: porter.v1.UpdateAppRequest.addon_overrides:type_name -> porter.v1.Addon
	...
	164, // 38: porter.v1.RollbackRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 39: porter.v1.DeleteAppDeploymentRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 40: porter.v1.DeleteDeploymentTargetRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 41: porter.v1.CurrentAppRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	162, // 42: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	161, // 43: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	161, // 44: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	167, // 45: porter.v1.AppRevisionStatusResponse.status:type_name -> porter.v1.EnumAppRevisionStatus
	168, // 46: porter.v1.UpdateRevisionPayload.image:type_name -> porter.v1.AppImage
	0,   // 47: porter.v1.UpdateRevisionPayload.triggered_by:type_name -> porter.v1.EnumUpdateTrigger
	164, // 48: porter.v1.RequireAppPayload.source_deployment_target:type_name -> porter.v1.DeploymentTargetIdentifier
	54,  // 49: porter.v1.CurrentAppRevisionResponse.app_revision:type_name -> porter.v1.AppRevision
	164, // 50: porter.v1.ListAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	54,  // 51: porter.v1.ListAppRevisionsResponse.app_revisions:type_name -> porter.v1.AppRevision
	164, // 52: porter.v1.LatestAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	...
	162, // 55: porter.v1.AppTemplateResponse.app_template:type_name -> porter.v1.PorterApp
	165, // 56: porter.v1.AppTemplateResponse.app_env:type_name -> porter.v1.EnvGroupVariables
	70,  // 57: porter.v1.AppTemplateResponse.addon_templates:type_name -> porter.v1.AddonWithEnvVars
	166, // 58: porter.v1.AddonTemplatesPayload.addon_templates:type_name -> porter.v1.Addon
	166, // 59: porter.v1.AddonWithEnvVars.addon:type_name -> porter.v1.Addon
	165, // 60: porter.v1.AddonWithEnvVars.env_vars:type_name -> porter.v1.EnvGroupVariables
	162, // 61: porter.v1.UpdateAppTemplateRequest.app_template:type_name -> porter.v1.PorterApp
	165, // 62: porter.v1.UpdateAppTemplateRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	70,  // 63: porter.v1.UpdateAppTemplateRequest.addon_templates:type_name -> porter.v1.AddonWithEnvVars
	164, // 64: porter.v1.LatestAddonsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	166, // 65: porter.v1.LatestAddonsResponse.addons:type_name -> porter.v1.Addon
	1,   // 66: porter.v1.PredeployStatusResponse.predeploy_status:type_name -> porter.v1.EnumPredeployStatus
	164, // 67: porter.v1.DeploymentTargetDetailsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	169, // 68: porter.v1.DeploymentTargetDetailsResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	169, // 69: porter.v1.DeploymentTargetsResponse.deployment_targets:type_name -> porter.v1.DeploymentTarget
	169, // 70: porter.v1.DefaultDeploymentTargetResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	170, // 71: porter.v1.EnvGroupVariablesRequest.env_group:type_name -> porter.v1.EnvGroup
	164, // 72: porter.v1.EnvGroupVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	165, // 73: porter.v1.EnvGroupVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	164, // 74: porter.v1.LatestEnvGroupWithVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	170, // 75: porter.v1.LatestEnvGroupWithVariablesResponse.env_group:type_name -> porter.v1.EnvGroup
	165, // 76: porter.v1.LatestEnvGroupWithVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	164, // 77: porter.v1.AppEnvVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	165, // 78: porter.v1.AppEnvVariablesResponse.env_variables:type_name -> porter.v1.EnvGroupVariables
	164, // 79: porter.v1.UpdateAppImageRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 80: porter.v1.UpdateAppBuildSettingsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	171, // 81: porter.v1.UpdateAppBuildSettingsRequest.build:type_name -> porter.v1.Build
	164, // 82: porter.v1.AppHelmValuesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 83: porter.v1.ManualServiceRunRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	168, // 84: porter.v1.ManualServiceRunRequest.image:type_name -> porter.v1.AppImage
	31,  // 85: porter.v1.ImagesResponse.images:type_name -> porter.v1.ImageInfo
	164, // 86: porter.v1.CreateAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 87: porter.v1.DeleteAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 88: porter.v1.ListAppInstancesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	113, // 89: porter.v1.ListAppInstancesResponse.app_instances:type_name -> porter.v1.AppInstance
	164, // 90: porter.v1.TemplateAppManifestsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 91: porter.v1.CreateNotificationRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	164, // 92: porter.v1.UpdateServiceDeploymentStatusRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	5,   // 93: porter.v1.UpdateServiceDeploymentStatusRequest.status:type_name -> porter.v1.EnumServiceDeploymentStatus
	172, // 94: porter.v1.CreateOrUpdateEnvGroupRequest.env_group_provider_type:type_name -> porter.v1.EnumEnvGroupProviderType
	172, // 95: porter.v1.DeleteEnvGroupRequest.env_group_provider_type:type_name -> porter.v1.EnumEnvGroupProviderType
	113, // 96: porter.v1.AppsLinkedToEnvGroupResponse.linked_apps:type_name -> porter.v1.AppInstance
	173, // 97: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	161, // 98: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	155, // 99: porter.v1.ClusterNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	174, // 100: porter.v1.ClusterNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	155, // 101: porter.v1.ListDatastoresRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	6,   // 102: porter.v1.ListDatastoresRequest.type:type_name -> porter.v1.EnumDatastore
	148, // 103: porter.v1.ListDatastoresResponse.datastores:type_name -> porter.v1.Datastore
	...
	149, // 106: porter.v1.Datastore.metadata:type_name -> porter.v1.DatastoreMetadata
	170, // 107: porter.v1.Datastore.env:type_name -> porter.v1.EnvGroup
	155, // 108: porter.v1.SharedNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	174, // 109: porter.v1.SharedNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	158, // 110: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	7,   // 111: porter.v1.ClusterControlPlaneService.QuotaIncrease:input_type -> porter.v1.QuotaIncreaseRequest
	175, // 112: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	...
	142, // 153: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:input_type -> porter.v1.ClusterNetworkSettingsRequest
	152, // 154: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:input_type -> porter.v1.SharedNetworkSettingsRequest
	...
	140, // 163: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	136, // 164: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	138, // 165: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	134, // 166: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	132, // 167: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	130, // 168: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	25,  // 169: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:input_type -> porter.v1.ListRepositoriesForRegistryRequest
	28,  // 170: porter.v1.ClusterControlPlaneService.ListImagesForRepository:input_type -> porter.v1.ListImagesForRepositoryRequest
	144, // 171: porter.v1.ClusterControlPlaneService.ListDatastores:input_type -> porter.v1.ListDatastoresRequest
	146, // 172: porter.v1.ClusterControlPlaneService.DatastoreStatus:input_type -> porter.v1.DatastoreStatusRequest
	150, // 173: porter.v1.ClusterControlPlaneService.RegistryStatus:input_type -> porter.v1.RegistryStatusRequest
	120, // 174: porter.v1.ClusterControlPlaneService.EnableExternalEnvGroupProviders:input_type -> porter.v1.EnableExternalEnvGroupProvidersRequest
	118, // 175: porter.v1.ClusterControlPlaneService.AreExternalEnvGroupProvidersEnabled:input_type -> porter.v1.AreExternalEnvGroupProvidersEnabledRequest
	122, // 176: porter.v1.ClusterControlPlaneService.CreateOrUpdateEnvGroup:input_type -> porter.v1.CreateOrUpdateEnvGroupRequest
	124, // 177: porter.v1.ClusterControlPlaneService.DeleteEnvGroup:input_type -> porter.v1.DeleteEnvGroupRequest
	126, // 178: porter.v1.ClusterControlPlaneService.AppsLinkedToEnvGroup:input_type -> porter.v1.AppsLinkedToEnvGroupRequest
	8,   // 179: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	176, // 180: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	12,  // 181: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	10,  // 182: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	14,  // 183: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	16,  // 184: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	18,  // 185: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	20,  // 186: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	36,  // 187: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	22,  // 188: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	24,  // 189: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	34,  // 190: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	38,  // 191: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	40,  // 192: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	42,  // 193: porter.v1.ClusterControlPlaneService.UpdateApp:output_type -> porter.v1.UpdateAppResponse
	46,  // 194: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	44,  // 195: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	56,  // 196: porter.v1.ClusterControlPlaneService.AppRevisionStatus:output_type -> porter.v1.AppRevisionStatusResponse
	48,  // 197: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	50,  // 198: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	52,  // 199: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	60,  // 200: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	62,  // 201: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	64,  // 202: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	66,  // 203: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	68,  // 204: porter.v1.ClusterControlPlaneService.AppTemplate:output_type -> porter.v1.AppTemplateResponse
	72,  // 205: porter.v1.ClusterControlPlaneService.UpdateAppTemplate:output_type -> porter.v1.UpdateAppTemplateResponse
	74,  // 206: porter.v1.ClusterControlPlaneService.LatestAddons:output_type -> porter.v1.LatestAddonsResponse
	76,  // 207: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	78,  // 208: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	80,  // 209: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:output_type -> porter.v1.CreateDeploymentTargetResponse
	82,  // 210: porter.v1.ClusterControlPlaneService.DeploymentTargets:output_type -> porter.v1.DeploymentTargetsResponse
	84,  // 211: porter.v1.ClusterControlPlaneService.DefaultDeploymentTarget:output_type -> porter.v1.DefaultDeploymentTargetResponse
	86,  // 212: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	88,  // 213: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	90,  // 214: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	92,  // 215: porter.v1.ClusterControlPlaneService.AppEnvVariables:output_type -> porter.v1.AppEnvVariablesResponse
	94,  // 216: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	96,  // 217: porter.v1.ClusterControlPlaneService.UpdateAppBuildSettings:output_type -> porter.v1.UpdateAppBuildSettingsResponse
	98,  // 218: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	100, // 219: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	102, // 220: porter.v1.ClusterControlPlaneService.ManualServiceRun:output_type -> porter.v1.ManualServiceRunResponse
	143, // 221: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:output_type -> porter.v1.ClusterNetworkSettingsResponse
	153, // 222: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:output_type -> porter.v1.SharedNetworkSettingsResponse
	104, // 223: porter.v1.ClusterControlPlaneService.Images:output_type -> porter.v1.ImagesResponse
	106, // 224: porter.v1.ClusterControlPlaneService.CreateAppInstance:output_type -> porter.v1.CreateAppInstanceResponse
	108, // 225: porter.v1.ClusterControlPlaneService.DeleteAppInstance:output_type -> porter.v1.DeleteAppInstanceResponse
	110, // 226: porter.v1.ClusterControlPlaneService.ListAppInstances:output_type -> porter.v1.ListAppInstancesResponse
	112, // 227: porter.v1.ClusterControlPlaneService.TemplateAppManifests:output_type -> porter.v1.TemplateAppManifestsResponse
	115, // 228: porter.v1.ClusterControlPlaneService.CreateNotification:output_type -> porter.v1.CreateNotificationResponse
	117, // 229: porter.v1.ClusterControlPlaneService.UpdateServiceDeploymentStatus:output_type -> porter.v1.UpdateServiceDeploymentStatusResponse
	129, // 230: porter.v1.ClusterControlPlaneService.ConnectHostedProject:output_type -> porter.v1.ConnectHostedProjectResponse
	141, // 231: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	137, // 232: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	139, // 233: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	135, // 234: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	133, // 235: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	131, // 236: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
	26,  // 237: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	29,  // 238: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	145, // 239: porter.v1.ClusterControlPlaneService.ListDatastores:output_type -> porter.v1.ListDatastoresResponse
	147, // 240: porter.v1.ClusterControlPlaneService.DatastoreStatus:output_type -> porter.v1.DatastoreStatusResponse
	151, // 241: porter.v1.ClusterControlPlaneService.RegistryStatus:output_type -> porter.v1.RegistryStatusResponse
	121, // 242: porter.v1.ClusterControlPlaneService.EnableExternalEnvGroupProviders:output_type -> porter.v1.EnableExternalEnvGroupProvidersResponse
	119, // 243: porter.v1.ClusterControlPlaneService.AreExternalEnvGroupProvidersEnabled:output_type -> porter.v1.AreExternalEnvGroupProvidersEnabledResponse
	123, // 244: porter.v1.ClusterControlPlaneService.CreateOrUpdateEnvGroup:output_type -> porter.v1.CreateOrUpdateEnvGroupResponse
	125, // 245: porter.v1.ClusterControlPlaneService.DeleteEnvGroup:output_type -> porter.v1.DeleteEnvGroupResponse
	127, // 246: porter.v1.ClusterControlPlaneService.AppsLinkedToEnvGroup:output_type -> porter.v1.AppsLinkedToEnvGroupResponse
	179, // [179:247] is the sub-list for method output_type
	111, // [111:179] is the sub-list for method input_type
...
func file_porter_v1_cluster_control_plane_proto_init() {
	...
	file_porter_v1_cluster_control_plane_proto_msgTypes[137].OneofWrappers = []interface{}{}
