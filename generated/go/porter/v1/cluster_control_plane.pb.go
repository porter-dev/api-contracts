...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x46, 0x55, 0x4c, 0x10, 0x04, 0x2a, 0xa2, 0x01, 0x0a, 0x0d,
	...
	0x32, 0xed, 0x2b, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x74,
...
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*Addon)(nil),                                  // 133: porter.v1.Addon
	(*AppImage)(nil),                               // 134: porter.v1.AppImage
	(*DeploymentTarget)(nil),                       // 135: porter.v1.DeploymentTarget
	(*EnvGroup)(nil),                               // 136: porter.v1.EnvGroup
	(*Build)(nil),                                  // 137: porter.v1.Build
	(*AssumeRoleChainLink)(nil),                    // 138: porter.v1.AssumeRoleChainLink
	(*AWSVpc)(nil),                                 // 139: porter.v1.AWSVpc
	(*UpdateCloudProviderCredentialsRequest)(nil),  // 140: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil), // 141: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	...
	133, // 34: porter.v1.UpdateAppRequest.addons:type_name -> porter.v1.Addon
	...
	131, // 37: porter.v1.RollbackRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 38: porter.v1.DeleteAppDeploymentRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 39: porter.v1.DeleteDeploymentTargetRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 40: porter.v1.CurrentAppRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	129, // 41: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	128, // 42: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	128, // 43: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	134, // 44: porter.v1.UpdateRevisionPayload.image:type_name -> porter.v1.AppImage
	131, // 45: porter.v1.RequireAppPayload.source_deployment_target:type_name -> porter.v1.DeploymentTargetIdentifier
	52,  // 46: porter.v1.CurrentAppRevisionResponse.app_revision:type_name -> porter.v1.AppRevision
	131, // 47: porter.v1.ListAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	52,  // 48: porter.v1.ListAppRevisionsResponse.app_revisions:type_name -> porter.v1.AppRevision
	131, // 49: porter.v1.LatestAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	52,  // 50: porter.v1.LatestAppRevisionsResponse.app_revisions:type_name -> porter.v1.AppRevision
	52,  // 51: porter.v1.GetAppRevisionResponse.app_revision:type_name -> porter.v1.AppRevision
	129, // 52: porter.v1.AppTemplateResponse.app_template:type_name -> porter.v1.PorterApp
	132, // 53: porter.v1.AppTemplateResponse.app_env:type_name -> porter.v1.EnvGroupVariables
	0,   // 54: porter.v1.PredeployStatusResponse.predeploy_status:type_name -> porter.v1.EnumPredeployStatus
	135, // 55: porter.v1.DeploymentTargetDetailsResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	135, // 56: porter.v1.DeploymentTargetsResponse.deployment_targets:type_name -> porter.v1.DeploymentTarget
	135, // 57: porter.v1.DefaultDeploymentTargetResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	136, // 58: porter.v1.EnvGroupVariablesRequest.env_group:type_name -> porter.v1.EnvGroup
	131, // 59: porter.v1.EnvGroupVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	132, // 60: porter.v1.EnvGroupVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	131, // 61: porter.v1.LatestEnvGroupWithVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	136, // 62: porter.v1.LatestEnvGroupWithVariablesResponse.env_group:type_name -> porter.v1.EnvGroup
	132, // 63: porter.v1.LatestEnvGroupWithVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	131, // 64: porter.v1.UpdateAppImageRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 65: porter.v1.UpdateAppBuildSettingsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	137, // 66: porter.v1.UpdateAppBuildSettingsRequest.build:type_name -> porter.v1.Build
	131, // 67: porter.v1.AppHelmValuesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 68: porter.v1.ManualServiceRunRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	29,  // 69: porter.v1.ImagesResponse.images:type_name -> porter.v1.ImageInfo
	131, // 70: porter.v1.CreateAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 71: porter.v1.DeleteAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 72: porter.v1.ListAppInstancesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	98,  // 73: porter.v1.ListAppInstancesResponse.app_instances:type_name -> porter.v1.AppInstance
	131, // 74: porter.v1.CreateNotificationRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	138, // 75: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	128, // 76: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	122, // 77: porter.v1.ClusterNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	139, // 78: porter.v1.ClusterNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	4,   // 79: porter.v1.DatastoreStatusRequest.type:type_name -> porter.v1.EnumDatastore
	122, // 80: porter.v1.SharedNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	139, // 81: porter.v1.SharedNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	125, // 82: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	5,   // 83: porter.v1.ClusterControlPlaneService.QuotaIncrease:input_type -> porter.v1.QuotaIncreaseRequest
	140, // 84: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	9,   // 85: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:input_type -> porter.v1.QuotaPreflightCheckRequest
	7,   // 86: porter.v1.ClusterControlPlaneService.PreflightCheck:input_type -> porter.v1.PreflightCheckRequest
	11,  // 87: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:input_type -> porter.v1.CreateAssumeRoleChainRequest
	13,  // 88: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:input_type -> porter.v1.SaveAzureCredentialsRequest
	15,  // 89: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:input_type -> porter.v1.KubeConfigForClusterRequest
	17,  // 90: porter.v1.ClusterControlPlaneService.UpdateContract:input_type -> porter.v1.UpdateContractRequest
	33,  // 91: porter.v1.ClusterControlPlaneService.ReadContract:input_type -> porter.v1.ReadContractRequest
	19,  // 92: porter.v1.ClusterControlPlaneService.ClusterStatus:input_type -> porter.v1.ClusterStatusRequest
	21,  // 93: porter.v1.ClusterControlPlaneService.DeleteCluster:input_type -> porter.v1.DeleteClusterRequest
	31,  // 94: porter.v1.ClusterControlPlaneService.TokenForRegistry:input_type -> porter.v1.TokenForRegistryRequest
	35,  // 95: porter.v1.ClusterControlPlaneService.ValidatePorterApp:input_type -> porter.v1.ValidatePorterAppRequest
	37,  // 96: porter.v1.ClusterControlPlaneService.ApplyPorterApp:input_type -> porter.v1.ApplyPorterAppRequest
	39,  // 97: porter.v1.ClusterControlPlaneService.UpdateApp:input_type -> porter.v1.UpdateAppRequest
	43,  // 98: porter.v1.ClusterControlPlaneService.RollbackRevision:input_type -> porter.v1.RollbackRevisionRequest
	41,  // 99: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:input_type -> porter.v1.UpdateRevisionStatusRequest
	45,  // 100: porter.v1.ClusterControlPlaneService.DeletePorterApp:input_type -> porter.v1.DeletePorterAppRequest
	47,  // 101: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:input_type -> porter.v1.DeleteAppDeploymentRequest
	49,  // 102: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:input_type -> porter.v1.DeleteDeploymentTargetRequest
	51,  // 103: porter.v1.ClusterControlPlaneService.CurrentAppRevision:input_type -> porter.v1.CurrentAppRevisionRequest
	56,  // 104: porter.v1.ClusterControlPlaneService.ListAppRevisions:input_type -> porter.v1.ListAppRevisionsRequest
	58,  // 105: porter.v1.ClusterControlPlaneService.LatestAppRevisions:input_type -> porter.v1.LatestAppRevisionsRequest
	60,  // 106: porter.v1.ClusterControlPlaneService.GetAppRevision:input_type -> porter.v1.GetAppRevisionRequest
	62,  // 107: porter.v1.ClusterControlPlaneService.AppTemplate:input_type -> porter.v1.AppTemplateRequest
	64,  // 108: porter.v1.ClusterControlPlaneService.PredeployStatus:input_type -> porter.v1.PredeployStatusRequest
	66,  // 109: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:input_type -> porter.v1.DeploymentTargetDetailsRequest
	68,  // 110: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:input_type -> porter.v1.CreateDeploymentTargetRequest
	70,  // 111: porter.v1.ClusterControlPlaneService.DeploymentTargets:input_type -> porter.v1.DeploymentTargetsRequest
	72,  // 112: porter.v1.ClusterControlPlaneService.DefaultDeploymentTarget:input_type -> porter.v1.DefaultDeploymentTargetRequest
	74,  // 113: porter.v1.ClusterControlPlaneService.SeedAppRevisions:input_type -> porter.v1.SeedAppRevisionsRequest
	76,  // 114: porter.v1.ClusterControlPlaneService.EnvGroupVariables:input_type -> porter.v1.EnvGroupVariablesRequest
	78,  // 115: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:input_type -> porter.v1.LatestEnvGroupWithVariablesRequest
	80,  // 116: porter.v1.ClusterControlPlaneService.UpdateAppImage:input_type -> porter.v1.UpdateAppImageRequest
	82,  // 117: porter.v1.ClusterControlPlaneService.UpdateAppBuildSettings:input_type -> porter.v1.UpdateAppBuildSettingsRequest
	84,  // 118: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:input_type -> porter.v1.UpdateAppsLinkedToEnvGroupRequest
	86,  // 119: porter.v1.ClusterControlPlaneService.AppHelmValues:input_type -> porter.v1.AppHelmValuesRequest
	88,  // 120: porter.v1.ClusterControlPlaneService.ManualServiceRun:input_type -> porter.v1.ManualServiceRunRequest
	113, // 121: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:input_type -> porter.v1.ClusterNetworkSettingsRequest
	119, // 122: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:input_type -> porter.v1.SharedNetworkSettingsRequest
	90,  // 123: porter.v1.ClusterControlPlaneService.Images:input_type -> porter.v1.ImagesRequest
	92,  // 124: porter.v1.ClusterControlPlaneService.CreateAppInstance:input_type -> porter.v1.CreateAppInstanceRequest
	94,  // 125: porter.v1.ClusterControlPlaneService.DeleteAppInstance:input_type -> porter.v1.DeleteAppInstanceRequest
	96,  // 126: porter.v1.ClusterControlPlaneService.ListAppInstances:input_type -> porter.v1.ListAppInstancesRequest
	99,  // 127: porter.v1.ClusterControlPlaneService.CreateNotification:input_type -> porter.v1.CreateNotificationRequest
	111, // 128: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	107, // 129: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	109, // 130: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	105, // 131: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	103, // 132: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	101, // 133: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	23,  // 134: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:input_type -> porter.v1.ListRepositoriesForRegistryRequest
	26,  // 135: porter.v1.ClusterControlPlaneService.ListImagesForRepository:input_type -> porter.v1.ListImagesForRepositoryRequest
	115, // 136: porter.v1.ClusterControlPlaneService.DatastoreStatus:input_type -> porter.v1.DatastoreStatusRequest
	117, // 137: porter.v1.ClusterControlPlaneService.RegistryStatus:input_type -> porter.v1.RegistryStatusRequest
	6,   // 138: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	141, // 139: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	10,  // 140: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	8,   // 141: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	12,  // 142: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	14,  // 143: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	16,  // 144: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	18,  // 145: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	34,  // 146: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	20,  // 147: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	22,  // 148: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	32,  // 149: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	36,  // 150: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	38,  // 151: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	40,  // 152: porter.v1.ClusterControlPlaneService.UpdateApp:output_type -> porter.v1.UpdateAppResponse
	44,  // 153: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	42,  // 154: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	46,  // 155: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	48,  // 156: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	50,  // 157: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	55,  // 158: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	57,  // 159: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	59,  // 160: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	61,  // 161: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	63,  // 162: porter.v1.ClusterControlPlaneService.AppTemplate:output_type -> porter.v1.AppTemplateResponse
	65,  // 163: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	67,  // 164: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	69,  // 165: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:output_type -> porter.v1.CreateDeploymentTargetResponse
	71,  // 166: porter.v1.ClusterControlPlaneService.DeploymentTargets:output_type -> porter.v1.DeploymentTargetsResponse
	73,  // 167: porter.v1.ClusterControlPlaneService.DefaultDeploymentTarget:output_type -> porter.v1.DefaultDeploymentTargetResponse
	75,  // 168: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	77,  // 169: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	79,  // 170: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	81,  // 171: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	83,  // 172: porter.v1.ClusterControlPlaneService.UpdateAppBuildSettings:output_type -> porter.v1.UpdateAppBuildSettingsResponse
	85,  // 173: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	87,  // 174: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	89,  // 175: porter.v1.ClusterControlPlaneService.ManualServiceRun:output_type -> porter.v1.ManualServiceRunResponse
	114, // 176: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:output_type -> porter.v1.ClusterNetworkSettingsResponse
	120, // 177: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:output_type -> porter.v1.SharedNetworkSettingsResponse
	91,  // 178: porter.v1.ClusterControlPlaneService.Images:output_type -> porter.v1.ImagesResponse
	93,  // 179: porter.v1.ClusterControlPlaneService.CreateAppInstance:output_type -> porter.v1.CreateAppInstanceResponse
	95,  // 180: porter.v1.ClusterControlPlaneService.DeleteAppInstance:output_type -> porter.v1.DeleteAppInstanceResponse
	97,  // 181: porter.v1.ClusterControlPlaneService.ListAppInstances:output_type -> porter.v1.ListAppInstancesResponse
	100, // 182: porter.v1.ClusterControlPlaneService.CreateNotification:output_type -> porter.v1.CreateNotificationResponse
	112, // 183: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	108, // 184: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	110, // 185: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	106, // 186: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	104, // 187: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	102, // 188: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
	24,  // 189: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	27,  // 190: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	116, // 191: porter.v1.ClusterControlPlaneService.DatastoreStatus:output_type -> porter.v1.DatastoreStatusResponse
	118, // 192: porter.v1.ClusterControlPlaneService.RegistryStatus:output_type -> porter.v1.RegistryStatusResponse
	138, // [138:193] is the sub-list for method output_type
	83,  // [83:138] is the sub-list for method input_type
