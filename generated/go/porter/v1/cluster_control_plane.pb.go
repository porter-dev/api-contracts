...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x4c, 0x10, 0x05, 0x32, 0xf3, 0x3f, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43,
...
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*CloudProviderPermissionsStatusRequest)(nil),       // 210: porter.v1.CloudProviderPermissionsStatusRequest
	(*UpdateCloudProviderCredentialsResponse)(nil),      // 211: porter.v1.UpdateCloudProviderCredentialsResponse
	(*CloudProviderPermissionsStatusResponse)(nil),      // 212: porter.v1.CloudProviderPermissionsStatusResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	...
	202, // 109: porter.v1.DeleteEnvGroupRequest.env_group_provider_type:type_name -> porter.v1.EnumEnvGroupProviderType
	124, // 110: porter.v1.AppsLinkedToEnvGroupResponse.linked_apps:type_name -> porter.v1.AppInstance
	199, // 111: porter.v1.ListEnvGroupsResponse.env_groups:type_name -> porter.v1.EnvGroup
	203, // 112: porter.v1.UpdateNotificationConfigRequest.config:type_name -> porter.v1.NotificationConfig
	203, // 113: porter.v1.NotificationConfigResponse.config:type_name -> porter.v1.NotificationConfig
	204, // 114: porter.v1.CreateDatastoreProxyResponse.credential:type_name -> porter.v1.DatastoreCredential
	...
	205, // 117: porter.v1.PatchCloudContractRequest.datastore:type_name -> porter.v1.ManagedDatastore
	206, // 118: porter.v1.PatchCloudContractResponse.cloud_contract:type_name -> porter.v1.CloudContract
	207, // 119: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	...
	208, // 122: porter.v1.ClusterNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	...
	208, // 131: porter.v1.SharedNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	...
	209, // 134: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	...
	210, // 191: porter.v1.ClusterControlPlaneService.CloudProviderPermissionsStatus:input_type -> porter.v1.CloudProviderPermissionsStatusRequest
	151, // 192: porter.v1.ClusterControlPlaneService.PatchCloudContract:input_type -> porter.v1.PatchCloudContractRequest
	163, // 193: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	159, // 194: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	161, // 195: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	157, // 196: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	155, // 197: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	153, // 198: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	30,  // 199: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:input_type -> porter.v1.ListRepositoriesForRegistryRequest
	33,  // 200: porter.v1.ClusterControlPlaneService.ListImagesForRepository:input_type -> porter.v1.ListImagesForRepositoryRequest
	167, // 201: porter.v1.ClusterControlPlaneService.ListDatastores:input_type -> porter.v1.ListDatastoresRequest
	169, // 202: porter.v1.ClusterControlPlaneService.DatastoreStatus:input_type -> porter.v1.DatastoreStatusRequest
	173, // 203: porter.v1.ClusterControlPlaneService.RegistryStatus:input_type -> porter.v1.RegistryStatusRequest
	131, // 204: porter.v1.ClusterControlPlaneService.EnableExternalEnvGroupProviders:input_type -> porter.v1.EnableExternalEnvGroupProvidersRequest
	129, // 205: porter.v1.ClusterControlPlaneService.AreExternalEnvGroupProvidersEnabled:input_type -> porter.v1.AreExternalEnvGroupProvidersEnabledRequest
	133, // 206: porter.v1.ClusterControlPlaneService.CreateOrUpdateEnvGroup:input_type -> porter.v1.CreateOrUpdateEnvGroupRequest
	135, // 207: porter.v1.ClusterControlPlaneService.DeleteEnvGroup:input_type -> porter.v1.DeleteEnvGroupRequest
	137, // 208: porter.v1.ClusterControlPlaneService.AppsLinkedToEnvGroup:input_type -> porter.v1.AppsLinkedToEnvGroupRequest
	139, // 209: porter.v1.ClusterControlPlaneService.ListEnvGroups:input_type -> porter.v1.ListEnvGroupsRequest
	141, // 210: porter.v1.ClusterControlPlaneService.UpdateNotificationConfig:input_type -> porter.v1.UpdateNotificationConfigRequest
	143, // 211: porter.v1.ClusterControlPlaneService.NotificationConfig:input_type -> porter.v1.NotificationConfigRequest
	10,  // 212: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	211, // 213: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	17,  // 214: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	12,  // 215: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	14,  // 216: porter.v1.ClusterControlPlaneService.CloudContractPreflightCheck:output_type -> porter.v1.CloudContractPreflightCheckResponse
	19,  // 217: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	21,  // 218: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	23,  // 219: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	25,  // 220: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	41,  // 221: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	27,  // 222: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	29,  // 223: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	39,  // 224: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	43,  // 225: porter.v1.ClusterControlPlaneService.ContractComplianceChecks:output_type -> porter.v1.ContractComplianceChecksResponse
	45,  // 226: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	47,  // 227: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	49,  // 228: porter.v1.ClusterControlPlaneService.UpdateApp:output_type -> porter.v1.UpdateAppResponse
	53,  // 229: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	51,  // 230: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	63,  // 231: porter.v1.ClusterControlPlaneService.AppRevisionStatus:output_type -> porter.v1.AppRevisionStatusResponse
	55,  // 232: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	57,  // 233: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	59,  // 234: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	67,  // 235: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	69,  // 236: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	71,  // 237: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	73,  // 238: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	75,  // 239: porter.v1.ClusterControlPlaneService.AppTemplate:output_type -> porter.v1.AppTemplateResponse
	79,  // 240: porter.v1.ClusterControlPlaneService.UpdateAppTemplate:output_type -> porter.v1.UpdateAppTemplateResponse
	81,  // 241: porter.v1.ClusterControlPlaneService.LatestAddons:output_type -> porter.v1.LatestAddonsResponse
	83,  // 242: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	85,  // 243: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	87,  // 244: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:output_type -> porter.v1.CreateDeploymentTargetResponse
	89,  // 245: porter.v1.ClusterControlPlaneService.DeploymentTargets:output_type -> porter.v1.DeploymentTargetsResponse
	91,  // 246: porter.v1.ClusterControlPlaneService.DefaultDeploymentTarget:output_type -> porter.v1.DefaultDeploymentTargetResponse
	93,  // 247: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	95,  // 248: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	97,  // 249: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	99,  // 250: porter.v1.ClusterControlPlaneService.AppEnvVariables:output_type -> porter.v1.AppEnvVariablesResponse
	101, // 251: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	103, // 252: porter.v1.ClusterControlPlaneService.UpdateAppBuildSettings:output_type -> porter.v1.UpdateAppBuildSettingsResponse
	105, // 253: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	107, // 254: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	109, // 255: porter.v1.ClusterControlPlaneService.ManualServiceRun:output_type -> porter.v1.ManualServiceRunResponse
	111, // 256: porter.v1.ClusterControlPlaneService.JobRunStatus:output_type -> porter.v1.JobRunStatusResponse
	113, // 257: porter.v1.ClusterControlPlaneService.JobRuns:output_type -> porter.v1.JobRunsResponse
	166, // 258: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:output_type -> porter.v1.ClusterNetworkSettingsResponse
	176, // 259: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:output_type -> porter.v1.SharedNetworkSettingsResponse
	115, // 260: porter.v1.ClusterControlPlaneService.Images:output_type -> porter.v1.ImagesResponse
	117, // 261: porter.v1.ClusterControlPlaneService.CreateAppInstance:output_type -> porter.v1.CreateAppInstanceResponse
	119, // 262: porter.v1.ClusterControlPlaneService.DeleteAppInstance:output_type -> porter.v1.DeleteAppInstanceResponse
	121, // 263: porter.v1.ClusterControlPlaneService.ListAppInstances:output_type -> porter.v1.ListAppInstancesResponse
	123, // 264: porter.v1.ClusterControlPlaneService.TemplateAppManifests:output_type -> porter.v1.TemplateAppManifestsResponse
	126, // 265: porter.v1.ClusterControlPlaneService.CreateNotification:output_type -> porter.v1.CreateNotificationResponse
	128, // 266: porter.v1.ClusterControlPlaneService.UpdateServiceDeploymentStatus:output_type -> porter.v1.UpdateServiceDeploymentStatusResponse
	146, // 267: porter.v1.ClusterControlPlaneService.ConnectHostedProject:output_type -> porter.v1.ConnectHostedProjectResponse
	148, // 268: porter.v1.ClusterControlPlaneService.UpdateDatastore:output_type -> porter.v1.UpdateDatastoreResponse
	150, // 269: porter.v1.ClusterControlPlaneService.CreateDatastoreProxy:output_type -> porter.v1.CreateDatastoreProxyResponse
	212, // 270: porter.v1.ClusterControlPlaneService.CloudProviderPermissionsStatus:output_type -> porter.v1.CloudProviderPermissionsStatusResponse
	152, // 271: porter.v1.ClusterControlPlaneService.PatchCloudContract:output_type -> porter.v1.PatchCloudContractResponse
	164, // 272: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	160, // 273: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	162, // 274: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	158, // 275: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	156, // 276: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	154, // 277: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
	31,  // 278: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	34,  // 279: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	168, // 280: porter.v1.ClusterControlPlaneService.ListDatastores:output_type -> porter.v1.ListDatastoresResponse
	170, // 281: porter.v1.ClusterControlPlaneService.DatastoreStatus:output_type -> porter.v1.DatastoreStatusResponse
	174, // 282: porter.v1.ClusterControlPlaneService.RegistryStatus:output_type -> porter.v1.RegistryStatusResponse
	132, // 283: porter.v1.ClusterControlPlaneService.EnableExternalEnvGroupProviders:output_type -> porter.v1.EnableExternalEnvGroupProvidersResponse
	130, // 284: porter.v1.ClusterControlPlaneService.AreExternalEnvGroupProvidersEnabled:output_type -> porter.v1.AreExternalEnvGroupProvidersEnabledResponse
	134, // 285: porter.v1.ClusterControlPlaneService.CreateOrUpdateEnvGroup:output_type -> porter.v1.CreateOrUpdateEnvGroupResponse
	136, // 286: porter.v1.ClusterControlPlaneService.DeleteEnvGroup:output_type -> porter.v1.DeleteEnvGroupResponse
	138, // 287: porter.v1.ClusterControlPlaneService.AppsLinkedToEnvGroup:output_type -> porter.v1.AppsLinkedToEnvGroupResponse
	140, // 288: porter.v1.ClusterControlPlaneService.ListEnvGroups:output_type -> porter.v1.ListEnvGroupsResponse
	142, // 289: porter.v1.ClusterControlPlaneService.UpdateNotificationConfig:output_type -> porter.v1.UpdateNotificationConfigResponse
	144, // 290: porter.v1.ClusterControlPlaneService.NotificationConfig:output_type -> porter.v1.NotificationConfigResponse
	212, // [212:291] is the sub-list for method output_type
	133, // [133:212] is the sub-list for method input_type
