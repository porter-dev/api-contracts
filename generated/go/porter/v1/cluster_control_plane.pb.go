...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x36, 0x34, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0x59, 0x0a, 0x15, 0x45, 0x4b, 0x53, 0x42,
	...
	0x02, 0x18, 0x01, 0x2a, 0xab, 0x01, 0x0a, 0x13, 0x45, 0x6e, 0x75, 0x6d, 0x50, 0x72, 0x65, 0x64,
	...
	0x03, 0x32, 0xd8, 0x1f, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*EKSBearerTokenRequest)(nil),               // 71: porter.v1.EKSBearerTokenRequest
	(*EKSBearerTokenResponse)(nil),              // 72: porter.v1.EKSBearerTokenResponse
	(*CertificateAuthorityDataRequest)(nil),     // 73: porter.v1.CertificateAuthorityDataRequest
	(*CertificateAuthorityDataResponse)(nil),    // 74: porter.v1.CertificateAuthorityDataResponse
	(*AssumeRoleChainTargetsRequest)(nil),       // 75: porter.v1.AssumeRoleChainTargetsRequest
	(*AssumeRoleChainTargetsResponse)(nil),      // 76: porter.v1.AssumeRoleChainTargetsResponse
	(*ECRTokenForRegistryRequest)(nil),          // 77: porter.v1.ECRTokenForRegistryRequest
	(*ECRTokenForRegistryResponse)(nil),         // 78: porter.v1.ECRTokenForRegistryResponse
	(*AssumeRoleCredentialsRequest)(nil),        // 79: porter.v1.AssumeRoleCredentialsRequest
	(*AssumeRoleCredentialsResponse)(nil),       // 80: porter.v1.AssumeRoleCredentialsResponse
	(*DockerConfigFileForRegistryRequest)(nil),  // 81: porter.v1.DockerConfigFileForRegistryRequest
	(*DockerConfigFileForRegistryResponse)(nil), // 82: porter.v1.DockerConfigFileForRegistryResponse
	nil,                           // 83: porter.v1.PreflightCheckResponse.PreflightChecksEntry
	(EnumCloudProvider)(0),        // 84: porter.v1.EnumCloudProvider
	(*GKEPreflightValues)(nil),    // 85: porter.v1.GKEPreflightValues
	(*EKSPreflightValues)(nil),    // 86: porter.v1.EKSPreflightValues
	(*Error)(nil),                 // 87: porter.v1.Error
	(*Contract)(nil),              // 88: porter.v1.Contract
	(*ContractRevision)(nil),      // 89: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil), // 90: google.protobuf.Timestamp
	(*PorterApp)(nil),             // 91: porter.v1.PorterApp
	(*Deletions)(nil),             // 92: porter.v1.Deletions
	(*EnvGroup)(nil),              // 93: porter.v1.EnvGroup
	(*EnvGroupVariables)(nil),     // 94: porter.v1.EnvGroupVariables
	(*AssumeRoleChainLink)(nil),   // 95: porter.v1.AssumeRoleChainLink
	(*UpdateCloudProviderCredentialsRequest)(nil),  // 96: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil), // 97: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	84, // 0: porter.v1.QuotaIncreaseRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	1,  // 1: porter.v1.QuotaIncreaseRequest.quota_increases:type_name -> porter.v1.EnumQuotaIncrease
	85, // 2: porter.v1.QuotaIncreaseRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	86, // 3: porter.v1.QuotaIncreaseRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	87, // 4: porter.v1.QuotaIncreaseResponse.error:type_name -> porter.v1.Error
	84, // 5: porter.v1.PreflightCheckRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	85, // 6: porter.v1.PreflightCheckRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	86, // 7: porter.v1.PreflightCheckRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	83, // 8: porter.v1.PreflightCheckResponse.preflight_checks:type_name -> porter.v1.PreflightCheckResponse.PreflightChecksEntry
	88, // 9: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	89, // 10: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	89, // 11: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	...
	90, // 14: porter.v1.Image.updated_at:type_name -> google.protobuf.Timestamp
	90, // 15: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	89, // 16: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	91, // 17: porter.v1.ValidatePorterAppRequest.app:type_name -> porter.v1.PorterApp
	92, // 18: porter.v1.ValidatePorterAppRequest.deletions:type_name -> porter.v1.Deletions
	91, // 19: porter.v1.ValidatePorterAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	91, // 20: porter.v1.ValidatePorterAppResponse.app:type_name -> porter.v1.PorterApp
	91, // 21: porter.v1.ApplyPorterAppRequest.app:type_name -> porter.v1.PorterApp
	...
	91, // 24: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	90, // 25: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	90, // 26: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	...
	93, // 32: porter.v1.EnvGroupVariablesRequest.env_group:type_name -> porter.v1.EnvGroup
	94, // 33: porter.v1.EnvGroupVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	93, // 34: porter.v1.LatestEnvGroupWithVariablesResponse.env_group:type_name -> porter.v1.EnvGroup
	94, // 35: porter.v1.LatestEnvGroupWithVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	95, // 36: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	90, // 37: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	87, // 38: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	4,  // 39: porter.v1.ClusterControlPlaneService.QuotaIncrease:input_type -> porter.v1.QuotaIncreaseRequest
	96, // 40: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	...
	81, // 72: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	77, // 73: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	79, // 74: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	75, // 75: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	73, // 76: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	71, // 77: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	5,  // 78: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	97, // 79: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	9,  // 80: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	7,  // 81: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	11, // 82: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	13, // 83: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	15, // 84: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	17, // 85: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	31, // 86: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	19, // 87: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	21, // 88: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	29, // 89: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	23, // 90: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	26, // 91: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	33, // 92: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	35, // 93: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	39, // 94: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	37, // 95: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	41, // 96: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	43, // 97: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	45, // 98: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	48, // 99: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	50, // 100: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	52, // 101: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	54, // 102: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	56, // 103: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	58, // 104: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	60, // 105: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	62, // 106: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	64, // 107: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	66, // 108: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	68, // 109: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	70, // 110: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	82, // 111: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	78, // 112: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	80, // 113: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	76, // 114: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	74, // 115: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	72, // 116: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
