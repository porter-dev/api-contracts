...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x52, 0x45, 0x53, 0x51, 0x4c, 0x10, 0x02, 0x32, 0x9b, 0x26, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 102)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*EKSBearerTokenRequest)(nil),                  // 90: porter.v1.EKSBearerTokenRequest
	(*EKSBearerTokenResponse)(nil),                 // 91: porter.v1.EKSBearerTokenResponse
	(*CertificateAuthorityDataRequest)(nil),        // 92: porter.v1.CertificateAuthorityDataRequest
	(*CertificateAuthorityDataResponse)(nil),       // 93: porter.v1.CertificateAuthorityDataResponse
	(*AssumeRoleChainTargetsRequest)(nil),          // 94: porter.v1.AssumeRoleChainTargetsRequest
	(*AssumeRoleChainTargetsResponse)(nil),         // 95: porter.v1.AssumeRoleChainTargetsResponse
	(*ECRTokenForRegistryRequest)(nil),             // 96: porter.v1.ECRTokenForRegistryRequest
	(*ECRTokenForRegistryResponse)(nil),            // 97: porter.v1.ECRTokenForRegistryResponse
	(*AssumeRoleCredentialsRequest)(nil),           // 98: porter.v1.AssumeRoleCredentialsRequest
	(*AssumeRoleCredentialsResponse)(nil),          // 99: porter.v1.AssumeRoleCredentialsResponse
	(*DockerConfigFileForRegistryRequest)(nil),     // 100: porter.v1.DockerConfigFileForRegistryRequest
	(*DockerConfigFileForRegistryResponse)(nil),    // 101: porter.v1.DockerConfigFileForRegistryResponse
	(*ClusterNetworkSettingsRequest)(nil),          // 102: porter.v1.ClusterNetworkSettingsRequest
	(*ClusterNetworkSettingsResponse)(nil),         // 103: porter.v1.ClusterNetworkSettingsResponse
	(*DatastoreStatusRequest)(nil),                 // 104: porter.v1.DatastoreStatusRequest
	(*DatastoreStatusResponse)(nil),                // 105: porter.v1.DatastoreStatusResponse
	nil,                                            // 106: porter.v1.PreflightCheckResponse.PreflightChecksEntry
	(EnumCloudProvider)(0),                         // 107: porter.v1.EnumCloudProvider
	(*GKEPreflightValues)(nil),                     // 108: porter.v1.GKEPreflightValues
	(*EKSPreflightValues)(nil),                     // 109: porter.v1.EKSPreflightValues
	(*Error)(nil),                                  // 110: porter.v1.Error
	(*Contract)(nil),                               // 111: porter.v1.Contract
	(*ContractRevision)(nil),                       // 112: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil),                  // 113: google.protobuf.Timestamp
	(*PorterApp)(nil),                              // 114: porter.v1.PorterApp
	(*Deletions)(nil),                              // 115: porter.v1.Deletions
	(*EnvGroupVariables)(nil),                      // 116: porter.v1.EnvGroupVariables
	(*EnvGroup)(nil),                               // 117: porter.v1.EnvGroup
	(*AssumeRoleChainLink)(nil),                    // 118: porter.v1.AssumeRoleChainLink
	(*AWSVpc)(nil),                                 // 119: porter.v1.AWSVpc
	(*UpdateCloudProviderCredentialsRequest)(nil),  // 120: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil), // 121: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	107, // 0: porter.v1.QuotaIncreaseRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	1,   // 1: porter.v1.QuotaIncreaseRequest.quota_increases:type_name -> porter.v1.EnumQuotaIncrease
	108, // 2: porter.v1.QuotaIncreaseRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	109, // 3: porter.v1.QuotaIncreaseRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	110, // 4: porter.v1.QuotaIncreaseResponse.error:type_name -> porter.v1.Error
	107, // 5: porter.v1.PreflightCheckRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	108, // 6: porter.v1.PreflightCheckRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	109, // 7: porter.v1.PreflightCheckRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	111, // 8: porter.v1.PreflightCheckRequest.contract:type_name -> porter.v1.Contract
	106, // 9: porter.v1.PreflightCheckResponse.preflight_checks:type_name -> porter.v1.PreflightCheckResponse.PreflightChecksEntry
	111, // 10: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	112, // 11: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	112, // 12: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	...
	113, // 15: porter.v1.Image.updated_at:type_name -> google.protobuf.Timestamp
	30,  // 16: porter.v1.ImageInfo.artifacts:type_name -> porter.v1.ImageArtifact
	113, // 17: porter.v1.ImageArtifact.updated_at:type_name -> google.protobuf.Timestamp
	113, // 18: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	112, // 19: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	114, // 20: porter.v1.ValidatePorterAppRequest.app:type_name -> porter.v1.PorterApp
	115, // 21: porter.v1.ValidatePorterAppRequest.deletions:type_name -> porter.v1.Deletions
	114, // 22: porter.v1.ValidatePorterAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	72,  // 23: porter.v1.ValidatePorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	114, // 24: porter.v1.ValidatePorterAppResponse.app:type_name -> porter.v1.PorterApp
	114, // 25: porter.v1.ApplyPorterAppRequest.app:type_name -> porter.v1.PorterApp
	116, // 26: porter.v1.ApplyPorterAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	...
	114, // 30: porter.v1.UpdateAppRequest.app:type_name -> porter.v1.PorterApp
	116, // 31: porter.v1.UpdateAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	115, // 32: porter.v1.UpdateAppRequest.deletions:type_name -> porter.v1.Deletions
	114, // 33: porter.v1.UpdateAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	...
	114, // 40: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	113, // 41: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	113, // 42: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	...
	114, // 49: porter.v1.AppTemplateResponse.app_template:type_name -> porter.v1.PorterApp
	116, // 50: porter.v1.AppTemplateResponse.app_env:type_name -> porter.v1.EnvGroupVariables
	0,   // 51: porter.v1.PredeployStatusResponse.predeploy_status:type_name -> porter.v1.EnumPredeployStatus
	117, // 52: porter.v1.EnvGroupVariablesRequest.env_group:type_name -> porter.v1.EnvGroup
	72,  // 53: porter.v1.EnvGroupVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	116, // 54: porter.v1.EnvGroupVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	...
	117, // 56: porter.v1.LatestEnvGroupWithVariablesResponse.env_group:type_name -> porter.v1.EnvGroup
	116, // 57: porter.v1.LatestEnvGroupWithVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	...
	118, // 64: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	113, // 65: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	107, // 66: porter.v1.ClusterNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	119, // 67: porter.v1.ClusterNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	4,   // 68: porter.v1.DatastoreStatusRequest.type:type_name -> porter.v1.EnumDatastore
	110, // 69: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	5,   // 70: porter.v1.ClusterControlPlaneService.QuotaIncrease:input_type -> porter.v1.QuotaIncreaseRequest
	120, // 71: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	9,   // 72: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:input_type -> porter.v1.QuotaPreflightCheckRequest
	7,   // 73: porter.v1.ClusterControlPlaneService.PreflightCheck:input_type -> porter.v1.PreflightCheckRequest
	11,  // 74: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:input_type -> porter.v1.CreateAssumeRoleChainRequest
	13,  // 75: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:input_type -> porter.v1.SaveAzureCredentialsRequest
	15,  // 76: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:input_type -> porter.v1.KubeConfigForClusterRequest
	17,  // 77: porter.v1.ClusterControlPlaneService.UpdateContract:input_type -> porter.v1.UpdateContractRequest
	33,  // 78: porter.v1.ClusterControlPlaneService.ReadContract:input_type -> porter.v1.ReadContractRequest
	19,  // 79: porter.v1.ClusterControlPlaneService.ClusterStatus:input_type -> porter.v1.ClusterStatusRequest
	21,  // 80: porter.v1.ClusterControlPlaneService.DeleteCluster:input_type -> porter.v1.DeleteClusterRequest
	31,  // 81: porter.v1.ClusterControlPlaneService.TokenForRegistry:input_type -> porter.v1.TokenForRegistryRequest
	35,  // 82: porter.v1.ClusterControlPlaneService.ValidatePorterApp:input_type -> porter.v1.ValidatePorterAppRequest
	37,  // 83: porter.v1.ClusterControlPlaneService.ApplyPorterApp:input_type -> porter.v1.ApplyPorterAppRequest
	39,  // 84: porter.v1.ClusterControlPlaneService.UpdateApp:input_type -> porter.v1.UpdateAppRequest
	43,  // 85: porter.v1.ClusterControlPlaneService.RollbackRevision:input_type -> porter.v1.RollbackRevisionRequest
	41,  // 86: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:input_type -> porter.v1.UpdateRevisionStatusRequest
	45,  // 87: porter.v1.ClusterControlPlaneService.DeletePorterApp:input_type -> porter.v1.DeletePorterAppRequest
	47,  // 88: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:input_type -> porter.v1.DeleteAppDeploymentRequest
	49,  // 89: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:input_type -> porter.v1.DeleteDeploymentTargetRequest
	51,  // 90: porter.v1.ClusterControlPlaneService.CurrentAppRevision:input_type -> porter.v1.CurrentAppRevisionRequest
	55,  // 91: porter.v1.ClusterControlPlaneService.ListAppRevisions:input_type -> porter.v1.ListAppRevisionsRequest
	57,  // 92: porter.v1.ClusterControlPlaneService.LatestAppRevisions:input_type -> porter.v1.LatestAppRevisionsRequest
	59,  // 93: porter.v1.ClusterControlPlaneService.GetAppRevision:input_type -> porter.v1.GetAppRevisionRequest
	61,  // 94: porter.v1.ClusterControlPlaneService.AppTemplate:input_type -> porter.v1.AppTemplateRequest
	63,  // 95: porter.v1.ClusterControlPlaneService.PredeployStatus:input_type -> porter.v1.PredeployStatusRequest
	65,  // 96: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:input_type -> porter.v1.DeploymentTargetDetailsRequest
	67,  // 97: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:input_type -> porter.v1.CreateDeploymentTargetRequest
	69,  // 98: porter.v1.ClusterControlPlaneService.SeedAppRevisions:input_type -> porter.v1.SeedAppRevisionsRequest
	71,  // 99: porter.v1.ClusterControlPlaneService.EnvGroupVariables:input_type -> porter.v1.EnvGroupVariablesRequest
	74,  // 100: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:input_type -> porter.v1.LatestEnvGroupWithVariablesRequest
	76,  // 101: porter.v1.ClusterControlPlaneService.UpdateAppImage:input_type -> porter.v1.UpdateAppImageRequest
	78,  // 102: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:input_type -> porter.v1.UpdateAppsLinkedToEnvGroupRequest
	80,  // 103: porter.v1.ClusterControlPlaneService.AppHelmValues:input_type -> porter.v1.AppHelmValuesRequest
	82,  // 104: porter.v1.ClusterControlPlaneService.ManualServiceRun:input_type -> porter.v1.ManualServiceRunRequest
	102, // 105: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:input_type -> porter.v1.ClusterNetworkSettingsRequest
	84,  // 106: porter.v1.ClusterControlPlaneService.Images:input_type -> porter.v1.ImagesRequest
	86,  // 107: porter.v1.ClusterControlPlaneService.CreateAppInstance:input_type -> porter.v1.CreateAppInstanceRequest
	88,  // 108: porter.v1.ClusterControlPlaneService.DeleteAppInstance:input_type -> porter.v1.DeleteAppInstanceRequest
	100, // 109: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	96,  // 110: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	98,  // 111: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	94,  // 112: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	92,  // 113: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	90,  // 114: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	23,  // 115: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:input_type -> porter.v1.ListRepositoriesForRegistryRequest
	26,  // 116: porter.v1.ClusterControlPlaneService.ListImagesForRepository:input_type -> porter.v1.ListImagesForRepositoryRequest
	104, // 117: porter.v1.ClusterControlPlaneService.DatastoreStatus:input_type -> porter.v1.DatastoreStatusRequest
	6,   // 118: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	121, // 119: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	10,  // 120: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	8,   // 121: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	12,  // 122: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	14,  // 123: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	16,  // 124: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	18,  // 125: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	34,  // 126: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	20,  // 127: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	22,  // 128: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	32,  // 129: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	36,  // 130: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	38,  // 131: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	40,  // 132: porter.v1.ClusterControlPlaneService.UpdateApp:output_type -> porter.v1.UpdateAppResponse
	44,  // 133: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	42,  // 134: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	46,  // 135: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	48,  // 136: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	50,  // 137: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	54,  // 138: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	56,  // 139: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	58,  // 140: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	60,  // 141: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	62,  // 142: porter.v1.ClusterControlPlaneService.AppTemplate:output_type -> porter.v1.AppTemplateResponse
	64,  // 143: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	66,  // 144: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	68,  // 145: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:output_type -> porter.v1.CreateDeploymentTargetResponse
	70,  // 146: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	73,  // 147: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	75,  // 148: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	77,  // 149: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	79,  // 150: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	81,  // 151: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	83,  // 152: porter.v1.ClusterControlPlaneService.ManualServiceRun:output_type -> porter.v1.ManualServiceRunResponse
	103, // 153: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:output_type -> porter.v1.ClusterNetworkSettingsResponse
	85,  // 154: porter.v1.ClusterControlPlaneService.Images:output_type -> porter.v1.ImagesResponse
	87,  // 155: porter.v1.ClusterControlPlaneService.CreateAppInstance:output_type -> porter.v1.CreateAppInstanceResponse
	89,  // 156: porter.v1.ClusterControlPlaneService.DeleteAppInstance:output_type -> porter.v1.DeleteAppInstanceResponse
	101, // 157: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	97,  // 158: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	99,  // 159: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	95,  // 160: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	93,  // 161: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	91,  // 162: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
	24,  // 163: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	27,  // 164: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	105, // 165: porter.v1.ClusterControlPlaneService.DatastoreStatus:output_type -> porter.v1.DatastoreStatusResponse
	118, // [118:166] is the sub-list for method output_type
	70,  // [70:118] is the sub-list for method input_type
...
func file_porter_v1_cluster_control_plane_proto_init() {
	...
	file_porter_v1_cluster_control_plane_proto_msgTypes[98].OneofWrappers = []interface{}{
