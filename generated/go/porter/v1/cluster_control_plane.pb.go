...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0xf1, 0x02, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x55,
	...
	0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x22, 0x20, 0x0a, 0x1e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x61, 0x63, 0x65, 0x22, 0xc1, 0x02, 0x0a, 0x19, 0x50, 0x61, 0x74, 0x63, 0x68, 0x43, 0x6c, 0x6f,
	...
	0x74, 0x6f, 0x72, 0x65, 0x42, 0x11, 0x0a, 0x0f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x5f, 0x52, 0x44, 0x53, 0x5f, 0x4d, 0x59, 0x53, 0x51, 0x4c, 0x10, 0x05, 0x32, 0xd5, 0x40, 0x0a,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 172)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	(*ReadCloudContractRequest)(nil),                    // 153: porter.v1.ReadCloudContractRequest
	(*ReadCloudContractResponse)(nil),                   // 154: porter.v1.ReadCloudContractResponse
	(*EKSBearerTokenRequest)(nil),                       // 155: porter.v1.EKSBearerTokenRequest
	(*EKSBearerTokenResponse)(nil),                      // 156: porter.v1.EKSBearerTokenResponse
	(*CertificateAuthorityDataRequest)(nil),             // 157: porter.v1.CertificateAuthorityDataRequest
	(*CertificateAuthorityDataResponse)(nil),            // 158: porter.v1.CertificateAuthorityDataResponse
	(*AssumeRoleChainTargetsRequest)(nil),               // 159: porter.v1.AssumeRoleChainTargetsRequest
	(*AssumeRoleChainTargetsResponse)(nil),              // 160: porter.v1.AssumeRoleChainTargetsResponse
	(*ECRTokenForRegistryRequest)(nil),                  // 161: porter.v1.ECRTokenForRegistryRequest
	(*ECRTokenForRegistryResponse)(nil),                 // 162: porter.v1.ECRTokenForRegistryResponse
	(*AssumeRoleCredentialsRequest)(nil),                // 163: porter.v1.AssumeRoleCredentialsRequest
	(*AssumeRoleCredentialsResponse)(nil),               // 164: porter.v1.AssumeRoleCredentialsResponse
	(*DockerConfigFileForRegistryRequest)(nil),          // 165: porter.v1.DockerConfigFileForRegistryRequest
	(*DockerConfigFileForRegistryResponse)(nil),         // 166: porter.v1.DockerConfigFileForRegistryResponse
	(*ClusterNetworkSettingsRequest)(nil),               // 167: porter.v1.ClusterNetworkSettingsRequest
	(*ClusterNetworkSettingsResponse)(nil),              // 168: porter.v1.ClusterNetworkSettingsResponse
	(*ListDatastoresRequest)(nil),                       // 169: porter.v1.ListDatastoresRequest
	(*ListDatastoresResponse)(nil),                      // 170: porter.v1.ListDatastoresResponse
	(*DatastoreStatusRequest)(nil),                      // 171: porter.v1.DatastoreStatusRequest
	(*DatastoreStatusResponse)(nil),                     // 172: porter.v1.DatastoreStatusResponse
	(*Datastore)(nil),                                   // 173: porter.v1.Datastore
	(*DatastoreMetadata)(nil),                           // 174: porter.v1.DatastoreMetadata
	(*RegistryStatusRequest)(nil),                       // 175: porter.v1.RegistryStatusRequest
	(*RegistryStatusResponse)(nil),                      // 176: porter.v1.RegistryStatusResponse
	(*SharedNetworkSettingsRequest)(nil),                // 177: porter.v1.SharedNetworkSettingsRequest
	(*SharedNetworkSettingsResponse)(nil),               // 178: porter.v1.SharedNetworkSettingsResponse
	nil,                                                 // 179: porter.v1.PreflightCheckResponse.PreflightChecksEntry
	nil,                                                 // 180: porter.v1.CloudContractPreflightCheck.MetadataEntry
	(EnumCloudProvider)(0),                              // 181: porter.v1.EnumCloudProvider
	(*GKEPreflightValues)(nil),                          // 182: porter.v1.GKEPreflightValues
	(*EKSPreflightValues)(nil),                          // 183: porter.v1.EKSPreflightValues
	(*Error)(nil),                                       // 184: porter.v1.Error
	(*Contract)(nil),                                    // 185: porter.v1.Contract
	(*ContractRevision)(nil),                            // 186: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil),                       // 187: google.protobuf.Timestamp
	(EnumComplianceVendor)(0),                           // 188: porter.v1.EnumComplianceVendor
	(EnumComplianceProfile)(0),                          // 189: porter.v1.EnumComplianceProfile
	(*ContractComplianceCheckGroup)(nil),                // 190: porter.v1.ContractComplianceCheckGroup
	(*VendorComplianceCheck)(nil),                       // 191: porter.v1.VendorComplianceCheck
	(*PorterApp)(nil),                                   // 192: porter.v1.PorterApp
	(*Deletions)(nil),                                   // 193: porter.v1.Deletions
	(*DeploymentTargetIdentifier)(nil),                  // 194: porter.v1.DeploymentTargetIdentifier
	(*EnvGroupVariables)(nil),                           // 195: porter.v1.EnvGroupVariables
	(*Addon)(nil),                                       // 196: porter.v1.Addon
	(EnumAppRevisionStatus)(0),                          // 197: porter.v1.EnumAppRevisionStatus
	(*AppImage)(nil),                                    // 198: porter.v1.AppImage
	(*PrerequisiteAddon)(nil),                           // 199: porter.v1.PrerequisiteAddon
	(*DeploymentTarget)(nil),                            // 200: porter.v1.DeploymentTarget
	(*EnvGroup)(nil),                                    // 201: porter.v1.EnvGroup
	(*Build)(nil),                                       // 202: porter.v1.Build
	(*JobRun)(nil),                                      // 203: porter.v1.JobRun
	(EnumEnvGroupProviderType)(0),                       // 204: porter.v1.EnumEnvGroupProviderType
	(*NotificationConfig)(nil),                          // 205: porter.v1.NotificationConfig
	(*DatastoreCredential)(nil),                         // 206: porter.v1.DatastoreCredential
	(*ManagedDatastore)(nil),                            // 207: porter.v1.ManagedDatastore
	(*CloudContract)(nil),                               // 208: porter.v1.CloudContract
	(*AssumeRoleChainLink)(nil),                         // 209: porter.v1.AssumeRoleChainLink
	(*AWSVpc)(nil),                                      // 210: porter.v1.AWSVpc
	(*UpdateCloudProviderCredentialsRequest)(nil),       // 211: porter.v1.UpdateCloudProviderCredentialsRequest
	(*CloudProviderPermissionsStatusRequest)(nil),       // 212: porter.v1.CloudProviderPermissionsStatusRequest
	(*UpdateCloudProviderCredentialsResponse)(nil),      // 213: porter.v1.UpdateCloudProviderCredentialsResponse
	(*CloudProviderPermissionsStatusResponse)(nil),      // 214: porter.v1.CloudProviderPermissionsStatusResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	181, // 0: porter.v1.QuotaIncreaseRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	2,   // 1: porter.v1.QuotaIncreaseRequest.quota_increases:type_name -> porter.v1.EnumQuotaIncrease
	182, // 2: porter.v1.QuotaIncreaseRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	183, // 3: porter.v1.QuotaIncreaseRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	184, // 4: porter.v1.QuotaIncreaseResponse.error:type_name -> porter.v1.Error
	181, // 5: porter.v1.PreflightCheckRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	182, // 6: porter.v1.PreflightCheckRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	183, // 7: porter.v1.PreflightCheckRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	185, // 8: porter.v1.PreflightCheckRequest.contract:type_name -> porter.v1.Contract
	179, // 9: porter.v1.PreflightCheckResponse.preflight_checks:type_name -> porter.v1.PreflightCheckResponse.PreflightChecksEntry
	185, // 10: porter.v1.CloudContractPreflightCheckRequest.contract:type_name -> porter.v1.Contract
	...
	180, // 12: porter.v1.CloudContractPreflightCheck.metadata:type_name -> porter.v1.CloudContractPreflightCheck.MetadataEntry
	185, // 13: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	186, // 14: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	186, // 15: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	...
	187, // 18: porter.v1.Image.updated_at:type_name -> google.protobuf.Timestamp
	37,  // 19: porter.v1.ImageInfo.artifacts:type_name -> porter.v1.ImageArtifact
	187, // 20: porter.v1.ImageArtifact.updated_at:type_name -> google.protobuf.Timestamp
	187, // 21: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	186, // 22: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	188, // 23: porter.v1.ContractComplianceChecksRequest.vendor:type_name -> porter.v1.EnumComplianceVendor
	189, // 24: porter.v1.ContractComplianceChecksRequest.profile:type_name -> porter.v1.EnumComplianceProfile
	190, // 25: porter.v1.ContractComplianceChecksResponse.check_groups:type_name -> porter.v1.ContractComplianceCheckGroup
	191, // 26: porter.v1.ContractComplianceChecksResponse.vendor_checks:type_name -> porter.v1.VendorComplianceCheck
	192, // 27: porter.v1.ValidatePorterAppRequest.app:type_name -> porter.v1.PorterApp
	193, // 28: porter.v1.ValidatePorterAppRequest.deletions:type_name -> porter.v1.Deletions
	192, // 29: porter.v1.ValidatePorterAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	194, // 30: porter.v1.ValidatePorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	192, // 31: porter.v1.ValidatePorterAppResponse.app:type_name -> porter.v1.PorterApp
	192, // 32: porter.v1.ApplyPorterAppRequest.app:type_name -> porter.v1.PorterApp
	195, // 33: porter.v1.ApplyPorterAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	194, // 34: porter.v1.ApplyPorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	3,   // 35: porter.v1.ApplyPorterAppResponse.cli_action:type_name -> porter.v1.EnumCLIAction
	194, // 36: porter.v1.UpdateAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	192, // 37: porter.v1.UpdateAppRequest.app:type_name -> porter.v1.PorterApp
	195, // 38: porter.v1.UpdateAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	193, // 39: porter.v1.UpdateAppRequest.deletions:type_name -> porter.v1.Deletions
	192, // 40: porter.v1.UpdateAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	196, // 41: porter.v1.UpdateAppRequest.addons:type_name -> porter.v1.Addon
	196, // 42: porter.v1.UpdateAppRequest.addon_overrides:type_name -> porter.v1.Addon
	195, // 43: porter.v1.UpdateAppRequest.app_env_overrides:type_name -> porter.v1.EnvGroupVariables
	...
	194, // 46: porter.v1.RollbackRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 47: porter.v1.DeleteAppDeploymentRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 48: porter.v1.DeleteDeploymentTargetRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 49: porter.v1.CurrentAppRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	192, // 50: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	187, // 51: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	187, // 52: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	197, // 53: porter.v1.AppRevisionStatusResponse.status:type_name -> porter.v1.EnumAppRevisionStatus
	198, // 54: porter.v1.UpdateRevisionPayload.image:type_name -> porter.v1.AppImage
	0,   // 55: porter.v1.UpdateRevisionPayload.triggered_by:type_name -> porter.v1.EnumUpdateTrigger
	199, // 56: porter.v1.UpdateRevisionPayload.prerequisite_addons:type_name -> porter.v1.PrerequisiteAddon
	194, // 57: porter.v1.RequireAppPayload.source_deployment_target:type_name -> porter.v1.DeploymentTargetIdentifier
	61,  // 58: porter.v1.CurrentAppRevisionResponse.app_revision:type_name -> porter.v1.AppRevision
	194, // 59: porter.v1.ListAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	61,  // 60: porter.v1.ListAppRevisionsResponse.app_revisions:type_name -> porter.v1.AppRevision
	194, // 61: porter.v1.LatestAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	...
	192, // 64: porter.v1.AppTemplateResponse.app_template:type_name -> porter.v1.PorterApp
	195, // 65: porter.v1.AppTemplateResponse.app_env:type_name -> porter.v1.EnvGroupVariables
	77,  // 66: porter.v1.AppTemplateResponse.addon_templates:type_name -> porter.v1.AddonWithEnvVars
	196, // 67: porter.v1.AddonTemplatesPayload.addon_templates:type_name -> porter.v1.Addon
	196, // 68: porter.v1.AddonWithEnvVars.addon:type_name -> porter.v1.Addon
	195, // 69: porter.v1.AddonWithEnvVars.env_vars:type_name -> porter.v1.EnvGroupVariables
	192, // 70: porter.v1.UpdateAppTemplateRequest.app_template:type_name -> porter.v1.PorterApp
	195, // 71: porter.v1.UpdateAppTemplateRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	77,  // 72: porter.v1.UpdateAppTemplateRequest.addon_templates:type_name -> porter.v1.AddonWithEnvVars
	194, // 73: porter.v1.LatestAddonsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	196, // 74: porter.v1.LatestAddonsResponse.addons:type_name -> porter.v1.Addon
	1,   // 75: porter.v1.PredeployStatusResponse.predeploy_status:type_name -> porter.v1.EnumPredeployStatus
	194, // 76: porter.v1.DeploymentTargetDetailsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	200, // 77: porter.v1.DeploymentTargetDetailsResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	200, // 78: porter.v1.DeploymentTargetsResponse.deployment_targets:type_name -> porter.v1.DeploymentTarget
	200, // 79: porter.v1.DefaultDeploymentTargetResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	201, // 80: porter.v1.EnvGroupVariablesRequest.env_group:type_name -> porter.v1.EnvGroup
	194, // 81: porter.v1.EnvGroupVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	195, // 82: porter.v1.EnvGroupVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	194, // 83: porter.v1.LatestEnvGroupWithVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	201, // 84: porter.v1.LatestEnvGroupWithVariablesResponse.env_group:type_name -> porter.v1.EnvGroup
	195, // 85: porter.v1.LatestEnvGroupWithVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	194, // 86: porter.v1.AppEnvVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	195, // 87: porter.v1.AppEnvVariablesResponse.env_variables:type_name -> porter.v1.EnvGroupVariables
	194, // 88: porter.v1.UpdateAppImageRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 89: porter.v1.UpdateAppBuildSettingsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	202, // 90: porter.v1.UpdateAppBuildSettingsRequest.build:type_name -> porter.v1.Build
	194, // 91: porter.v1.AppHelmValuesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 92: porter.v1.ManualServiceRunRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	198, // 93: porter.v1.ManualServiceRunRequest.image:type_name -> porter.v1.AppImage
	194, // 94: porter.v1.JobRunStatusRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	203, // 95: porter.v1.JobRunStatusResponse.job_run:type_name -> porter.v1.JobRun
	194, // 96: porter.v1.JobRunsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	203, // 97: porter.v1.JobRunsResponse.job_runs:type_name -> porter.v1.JobRun
	36,  // 98: porter.v1.ImagesResponse.images:type_name -> porter.v1.ImageInfo
	194, // 99: porter.v1.CreateAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 100: porter.v1.DeleteAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 101: porter.v1.ListAppInstancesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	124, // 102: porter.v1.ListAppInstancesResponse.app_instances:type_name -> porter.v1.AppInstance
	194, // 103: porter.v1.TemplateAppManifestsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 104: porter.v1.CreateNotificationRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	194, // 105: porter.v1.UpdateServiceDeploymentStatusRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	5,   // 106: porter.v1.UpdateServiceDeploymentStatusRequest.status:type_name -> porter.v1.EnumServiceDeploymentStatus
	204, // 107: porter.v1.CreateOrUpdateEnvGroupRequest.env_group_provider_type:type_name -> porter.v1.EnumEnvGroupProviderType
	195, // 108: porter.v1.CreateOrUpdateEnvGroupRequest.env_vars:type_name -> porter.v1.EnvGroupVariables
	204, // 109: porter.v1.DeleteEnvGroupRequest.env_group_provider_type:type_name -> porter.v1.EnumEnvGroupProviderType
	124, // 110: porter.v1.AppsLinkedToEnvGroupResponse.linked_apps:type_name -> porter.v1.AppInstance
	201, // 111: porter.v1.ListEnvGroupsResponse.env_groups:type_name -> porter.v1.EnvGroup
	205, // 112: porter.v1.UpdateNotificationConfigRequest.config:type_name -> porter.v1.NotificationConfig
	205, // 113: porter.v1.NotificationConfigResponse.config:type_name -> porter.v1.NotificationConfig
	206, // 114: porter.v1.CreateDatastoreProxyResponse.credential:type_name -> porter.v1.DatastoreCredential
	6,   // 115: porter.v1.PatchCloudContractRequest.operation:type_name -> porter.v1.EnumPatchCloudContractOperation
	7,   // 116: porter.v1.PatchCloudContractRequest.resource_type:type_name -> porter.v1.EnumPatchCloudContractType
	207, // 117: porter.v1.PatchCloudContractRequest.datastore:type_name -> porter.v1.ManagedDatastore
	208, // 118: porter.v1.PatchCloudContractResponse.cloud_contract:type_name -> porter.v1.CloudContract
	208, // 119: porter.v1.ReadCloudContractResponse.cloud_contract:type_name -> porter.v1.CloudContract
	209, // 120: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	187, // 121: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	181, // 122: porter.v1.ClusterNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	210, // 123: porter.v1.ClusterNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	181, // 124: porter.v1.ListDatastoresRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	8,   // 125: porter.v1.ListDatastoresRequest.type:type_name -> porter.v1.EnumDatastore
	173, // 126: porter.v1.ListDatastoresResponse.datastores:type_name -> porter.v1.Datastore
	...
	174, // 129: porter.v1.Datastore.metadata:type_name -> porter.v1.DatastoreMetadata
	201, // 130: porter.v1.Datastore.env:type_name -> porter.v1.EnvGroup
	181, // 131: porter.v1.SharedNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	210, // 132: porter.v1.SharedNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	184, // 133: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	9,   // 134: porter.v1.ClusterControlPlaneService.QuotaIncrease:input_type -> porter.v1.QuotaIncreaseRequest
	211, // 135: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	...
	167, // 180: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:input_type -> porter.v1.ClusterNetworkSettingsRequest
	177, // 181: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:input_type -> porter.v1.SharedNetworkSettingsRequest
	...
	212, // 192: porter.v1.ClusterControlPlaneService.CloudProviderPermissionsStatus:input_type -> porter.v1.CloudProviderPermissionsStatusRequest
	151, // 193: porter.v1.ClusterControlPlaneService.PatchCloudContract:input_type -> porter.v1.PatchCloudContractRequest
	153, // 194: porter.v1.ClusterControlPlaneService.ReadCloudContract:input_type -> porter.v1.ReadCloudContractRequest
	165, // 195: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:input_type -> porter.v1.DockerConfigFileForRegistryRequest
	161, // 196: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:input_type -> porter.v1.ECRTokenForRegistryRequest
	163, // 197: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:input_type -> porter.v1.AssumeRoleCredentialsRequest
	159, // 198: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:input_type -> porter.v1.AssumeRoleChainTargetsRequest
	157, // 199: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:input_type -> porter.v1.CertificateAuthorityDataRequest
	155, // 200: porter.v1.ClusterControlPlaneService.EKSBearerToken:input_type -> porter.v1.EKSBearerTokenRequest
	30,  // 201: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:input_type -> porter.v1.ListRepositoriesForRegistryRequest
	33,  // 202: porter.v1.ClusterControlPlaneService.ListImagesForRepository:input_type -> porter.v1.ListImagesForRepositoryRequest
	169, // 203: porter.v1.ClusterControlPlaneService.ListDatastores:input_type -> porter.v1.ListDatastoresRequest
	171, // 204: porter.v1.ClusterControlPlaneService.DatastoreStatus:input_type -> porter.v1.DatastoreStatusRequest
	175, // 205: porter.v1.ClusterControlPlaneService.RegistryStatus:input_type -> porter.v1.RegistryStatusRequest
	131, // 206: porter.v1.ClusterControlPlaneService.EnableExternalEnvGroupProviders:input_type -> porter.v1.EnableExternalEnvGroupProvidersRequest
	129, // 207: porter.v1.ClusterControlPlaneService.AreExternalEnvGroupProvidersEnabled:input_type -> porter.v1.AreExternalEnvGroupProvidersEnabledRequest
	133, // 208: porter.v1.ClusterControlPlaneService.CreateOrUpdateEnvGroup:input_type -> porter.v1.CreateOrUpdateEnvGroupRequest
	135, // 209: porter.v1.ClusterControlPlaneService.DeleteEnvGroup:input_type -> porter.v1.DeleteEnvGroupRequest
	137, // 210: porter.v1.ClusterControlPlaneService.AppsLinkedToEnvGroup:input_type -> porter.v1.AppsLinkedToEnvGroupRequest
	139, // 211: porter.v1.ClusterControlPlaneService.ListEnvGroups:input_type -> porter.v1.ListEnvGroupsRequest
	141, // 212: porter.v1.ClusterControlPlaneService.UpdateNotificationConfig:input_type -> porter.v1.UpdateNotificationConfigRequest
	143, // 213: porter.v1.ClusterControlPlaneService.NotificationConfig:input_type -> porter.v1.NotificationConfigRequest
	10,  // 214: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	213, // 215: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	17,  // 216: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	12,  // 217: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	14,  // 218: porter.v1.ClusterControlPlaneService.CloudContractPreflightCheck:output_type -> porter.v1.CloudContractPreflightCheckResponse
	19,  // 219: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	21,  // 220: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	23,  // 221: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	25,  // 222: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	41,  // 223: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	27,  // 224: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	29,  // 225: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	39,  // 226: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	43,  // 227: porter.v1.ClusterControlPlaneService.ContractComplianceChecks:output_type -> porter.v1.ContractComplianceChecksResponse
	45,  // 228: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	47,  // 229: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	49,  // 230: porter.v1.ClusterControlPlaneService.UpdateApp:output_type -> porter.v1.UpdateAppResponse
	53,  // 231: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	51,  // 232: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	63,  // 233: porter.v1.ClusterControlPlaneService.AppRevisionStatus:output_type -> porter.v1.AppRevisionStatusResponse
	55,  // 234: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	57,  // 235: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	59,  // 236: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	67,  // 237: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	69,  // 238: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	71,  // 239: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	73,  // 240: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	75,  // 241: porter.v1.ClusterControlPlaneService.AppTemplate:output_type -> porter.v1.AppTemplateResponse
	79,  // 242: porter.v1.ClusterControlPlaneService.UpdateAppTemplate:output_type -> porter.v1.UpdateAppTemplateResponse
	81,  // 243: porter.v1.ClusterControlPlaneService.LatestAddons:output_type -> porter.v1.LatestAddonsResponse
	83,  // 244: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	85,  // 245: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	87,  // 246: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:output_type -> porter.v1.CreateDeploymentTargetResponse
	89,  // 247: porter.v1.ClusterControlPlaneService.DeploymentTargets:output_type -> porter.v1.DeploymentTargetsResponse
	91,  // 248: porter.v1.ClusterControlPlaneService.DefaultDeploymentTarget:output_type -> porter.v1.DefaultDeploymentTargetResponse
	93,  // 249: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	95,  // 250: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	97,  // 251: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	99,  // 252: porter.v1.ClusterControlPlaneService.AppEnvVariables:output_type -> porter.v1.AppEnvVariablesResponse
	101, // 253: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	103, // 254: porter.v1.ClusterControlPlaneService.UpdateAppBuildSettings:output_type -> porter.v1.UpdateAppBuildSettingsResponse
	105, // 255: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	107, // 256: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	109, // 257: porter.v1.ClusterControlPlaneService.ManualServiceRun:output_type -> porter.v1.ManualServiceRunResponse
	111, // 258: porter.v1.ClusterControlPlaneService.JobRunStatus:output_type -> porter.v1.JobRunStatusResponse
	113, // 259: porter.v1.ClusterControlPlaneService.JobRuns:output_type -> porter.v1.JobRunsResponse
	168, // 260: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:output_type -> porter.v1.ClusterNetworkSettingsResponse
	178, // 261: porter.v1.ClusterControlPlaneService.SharedNetworkSettings:output_type -> porter.v1.SharedNetworkSettingsResponse
	115, // 262: porter.v1.ClusterControlPlaneService.Images:output_type -> porter.v1.ImagesResponse
	117, // 263: porter.v1.ClusterControlPlaneService.CreateAppInstance:output_type -> porter.v1.CreateAppInstanceResponse
	119, // 264: porter.v1.ClusterControlPlaneService.DeleteAppInstance:output_type -> porter.v1.DeleteAppInstanceResponse
	121, // 265: porter.v1.ClusterControlPlaneService.ListAppInstances:output_type -> porter.v1.ListAppInstancesResponse
	123, // 266: porter.v1.ClusterControlPlaneService.TemplateAppManifests:output_type -> porter.v1.TemplateAppManifestsResponse
	126, // 267: porter.v1.ClusterControlPlaneService.CreateNotification:output_type -> porter.v1.CreateNotificationResponse
	128, // 268: porter.v1.ClusterControlPlaneService.UpdateServiceDeploymentStatus:output_type -> porter.v1.UpdateServiceDeploymentStatusResponse
	146, // 269: porter.v1.ClusterControlPlaneService.ConnectHostedProject:output_type -> porter.v1.ConnectHostedProjectResponse
	148, // 270: porter.v1.ClusterControlPlaneService.UpdateDatastore:output_type -> porter.v1.UpdateDatastoreResponse
	150, // 271: porter.v1.ClusterControlPlaneService.CreateDatastoreProxy:output_type -> porter.v1.CreateDatastoreProxyResponse
	214, // 272: porter.v1.ClusterControlPlaneService.CloudProviderPermissionsStatus:output_type -> porter.v1.CloudProviderPermissionsStatusResponse
	152, // 273: porter.v1.ClusterControlPlaneService.PatchCloudContract:output_type -> porter.v1.PatchCloudContractResponse
	154, // 274: porter.v1.ClusterControlPlaneService.ReadCloudContract:output_type -> porter.v1.ReadCloudContractResponse
	166, // 275: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	162, // 276: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	164, // 277: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	160, // 278: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	158, // 279: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	156, // 280: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
	31,  // 281: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	34,  // 282: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	170, // 283: porter.v1.ClusterControlPlaneService.ListDatastores:output_type -> porter.v1.ListDatastoresResponse
	172, // 284: porter.v1.ClusterControlPlaneService.DatastoreStatus:output_type -> porter.v1.DatastoreStatusResponse
	176, // 285: porter.v1.ClusterControlPlaneService.RegistryStatus:output_type -> porter.v1.RegistryStatusResponse
	132, // 286: porter.v1.ClusterControlPlaneService.EnableExternalEnvGroupProviders:output_type -> porter.v1.EnableExternalEnvGroupProvidersResponse
	130, // 287: porter.v1.ClusterControlPlaneService.AreExternalEnvGroupProvidersEnabled:output_type -> porter.v1.AreExternalEnvGroupProvidersEnabledResponse
	134, // 288: porter.v1.ClusterControlPlaneService.CreateOrUpdateEnvGroup:output_type -> porter.v1.CreateOrUpdateEnvGroupResponse
	136, // 289: porter.v1.ClusterControlPlaneService.DeleteEnvGroup:output_type -> porter.v1.DeleteEnvGroupResponse
	138, // 290: porter.v1.ClusterControlPlaneService.AppsLinkedToEnvGroup:output_type -> porter.v1.AppsLinkedToEnvGroupResponse
	140, // 291: porter.v1.ClusterControlPlaneService.ListEnvGroups:output_type -> porter.v1.ListEnvGroupsResponse
	142, // 292: porter.v1.ClusterControlPlaneService.UpdateNotificationConfig:output_type -> porter.v1.UpdateNotificationConfigResponse
	144, // 293: porter.v1.ClusterControlPlaneService.NotificationConfig:output_type -> porter.v1.NotificationConfigResponse
...
func file_porter_v1_cluster_control_plane_proto_init() {
	...
	file_porter_v1_cluster_control_plane_proto_msgTypes[159].OneofWrappers = []interface{}{
		(*ClusterNetworkSettingsResponse_EksCloudProviderNetwork)(nil),
	}
	file_porter_v1_cluster_control_plane_proto_msgTypes[160].OneofWrappers = []interface{}{}
