...
var file_porter_v1_cluster_control_plane_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x2a, 0xab, 0x01, 0x0a, 0x13, 0x45, 0x6e, 0x75, 0x6d, 0x50, 0x72, 0x65, 0x64,
	...
	0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x46, 0x55, 0x4c, 0x10, 0x04, 0x2a, 0xa2, 0x01, 0x0a,
	...
	0x03, 0x32, 0xa6, 0x2a, 0x0a, 0x1a, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x43, 0x6f, 0x6e,
...
var file_porter_v1_cluster_control_plane_proto_msgTypes = make([]protoimpl.MessageInfo, 113)
var file_porter_v1_cluster_control_plane_proto_goTypes = []interface{}{
	...
	nil,                                            // 117: porter.v1.PreflightCheckResponse.PreflightChecksEntry
	(EnumCloudProvider)(0),                         // 118: porter.v1.EnumCloudProvider
	(*GKEPreflightValues)(nil),                     // 119: porter.v1.GKEPreflightValues
	(*EKSPreflightValues)(nil),                     // 120: porter.v1.EKSPreflightValues
	(*Error)(nil),                                  // 121: porter.v1.Error
	(*Contract)(nil),                               // 122: porter.v1.Contract
	(*ContractRevision)(nil),                       // 123: porter.v1.ContractRevision
	(*timestamppb.Timestamp)(nil),                  // 124: google.protobuf.Timestamp
	(*PorterApp)(nil),                              // 125: porter.v1.PorterApp
	(*Deletions)(nil),                              // 126: porter.v1.Deletions
	(*DeploymentTargetIdentifier)(nil),             // 127: porter.v1.DeploymentTargetIdentifier
	(*EnvGroupVariables)(nil),                      // 128: porter.v1.EnvGroupVariables
	(*AppImage)(nil),                               // 129: porter.v1.AppImage
	(*DeploymentTarget)(nil),                       // 130: porter.v1.DeploymentTarget
	(*EnvGroup)(nil),                               // 131: porter.v1.EnvGroup
	(*Build)(nil),                                  // 132: porter.v1.Build
	(*AssumeRoleChainLink)(nil),                    // 133: porter.v1.AssumeRoleChainLink
	(*AWSVpc)(nil),                                 // 134: porter.v1.AWSVpc
	(*UpdateCloudProviderCredentialsRequest)(nil),  // 135: porter.v1.UpdateCloudProviderCredentialsRequest
	(*UpdateCloudProviderCredentialsResponse)(nil), // 136: porter.v1.UpdateCloudProviderCredentialsResponse
}
var file_porter_v1_cluster_control_plane_proto_depIdxs = []int32{
	118, // 0: porter.v1.QuotaIncreaseRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	1,   // 1: porter.v1.QuotaIncreaseRequest.quota_increases:type_name -> porter.v1.EnumQuotaIncrease
	119, // 2: porter.v1.QuotaIncreaseRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	120, // 3: porter.v1.QuotaIncreaseRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	121, // 4: porter.v1.QuotaIncreaseResponse.error:type_name -> porter.v1.Error
	118, // 5: porter.v1.PreflightCheckRequest.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	119, // 6: porter.v1.PreflightCheckRequest.gke_preflight_values:type_name -> porter.v1.GKEPreflightValues
	120, // 7: porter.v1.PreflightCheckRequest.eks_preflight_values:type_name -> porter.v1.EKSPreflightValues
	122, // 8: porter.v1.PreflightCheckRequest.contract:type_name -> porter.v1.Contract
	117, // 9: porter.v1.PreflightCheckResponse.preflight_checks:type_name -> porter.v1.PreflightCheckResponse.PreflightChecksEntry
	122, // 10: porter.v1.UpdateContractRequest.contract:type_name -> porter.v1.Contract
	123, // 11: porter.v1.UpdateContractResponse.contract_revision:type_name -> porter.v1.ContractRevision
	123, // 12: porter.v1.DeleteClusterRequest.contract_revision:type_name -> porter.v1.ContractRevision
	...
	124, // 15: porter.v1.Image.updated_at:type_name -> google.protobuf.Timestamp
	30,  // 16: porter.v1.ImageInfo.artifacts:type_name -> porter.v1.ImageArtifact
	124, // 17: porter.v1.ImageArtifact.updated_at:type_name -> google.protobuf.Timestamp
	124, // 18: porter.v1.TokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	123, // 19: porter.v1.ReadContractRequest.contract_revision:type_name -> porter.v1.ContractRevision
	125, // 20: porter.v1.ValidatePorterAppRequest.app:type_name -> porter.v1.PorterApp
	126, // 21: porter.v1.ValidatePorterAppRequest.deletions:type_name -> porter.v1.Deletions
	125, // 22: porter.v1.ValidatePorterAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	127, // 23: porter.v1.ValidatePorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	125, // 24: porter.v1.ValidatePorterAppResponse.app:type_name -> porter.v1.PorterApp
	125, // 25: porter.v1.ApplyPorterAppRequest.app:type_name -> porter.v1.PorterApp
	128, // 26: porter.v1.ApplyPorterAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	127, // 27: porter.v1.ApplyPorterAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	2,   // 28: porter.v1.ApplyPorterAppResponse.cli_action:type_name -> porter.v1.EnumCLIAction
	127, // 29: porter.v1.UpdateAppRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	125, // 30: porter.v1.UpdateAppRequest.app:type_name -> porter.v1.PorterApp
	128, // 31: porter.v1.UpdateAppRequest.app_env:type_name -> porter.v1.EnvGroupVariables
	126, // 32: porter.v1.UpdateAppRequest.deletions:type_name -> porter.v1.Deletions
	125, // 33: porter.v1.UpdateAppRequest.app_overrides:type_name -> porter.v1.PorterApp
	...
	127, // 36: porter.v1.RollbackRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 37: porter.v1.DeleteAppDeploymentRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 38: porter.v1.DeleteDeploymentTargetRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 39: porter.v1.CurrentAppRevisionRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	125, // 40: porter.v1.AppRevision.app:type_name -> porter.v1.PorterApp
	124, // 41: porter.v1.AppRevision.created_at:type_name -> google.protobuf.Timestamp
	124, // 42: porter.v1.AppRevision.updated_at:type_name -> google.protobuf.Timestamp
	129, // 43: porter.v1.UpdateRevisionPayload.image:type_name -> porter.v1.AppImage
	127, // 44: porter.v1.RequireAppPayload.source_deployment_target:type_name -> porter.v1.DeploymentTargetIdentifier
	52,  // 45: porter.v1.CurrentAppRevisionResponse.app_revision:type_name -> porter.v1.AppRevision
	127, // 46: porter.v1.ListAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	52,  // 47: porter.v1.ListAppRevisionsResponse.app_revisions:type_name -> porter.v1.AppRevision
	127, // 48: porter.v1.LatestAppRevisionsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	...
	125, // 51: porter.v1.AppTemplateResponse.app_template:type_name -> porter.v1.PorterApp
	128, // 52: porter.v1.AppTemplateResponse.app_env:type_name -> porter.v1.EnvGroupVariables
	0,   // 53: porter.v1.PredeployStatusResponse.predeploy_status:type_name -> porter.v1.EnumPredeployStatus
	130, // 54: porter.v1.DeploymentTargetDetailsResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	130, // 55: porter.v1.DeploymentTargetsResponse.deployment_targets:type_name -> porter.v1.DeploymentTarget
	130, // 56: porter.v1.DefaultDeploymentTargetResponse.deployment_target:type_name -> porter.v1.DeploymentTarget
	131, // 57: porter.v1.EnvGroupVariablesRequest.env_group:type_name -> porter.v1.EnvGroup
	127, // 58: porter.v1.EnvGroupVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	128, // 59: porter.v1.EnvGroupVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	127, // 60: porter.v1.LatestEnvGroupWithVariablesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	131, // 61: porter.v1.LatestEnvGroupWithVariablesResponse.env_group:type_name -> porter.v1.EnvGroup
	128, // 62: porter.v1.LatestEnvGroupWithVariablesResponse.env_group_variables:type_name -> porter.v1.EnvGroupVariables
	127, // 63: porter.v1.UpdateAppImageRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 64: porter.v1.UpdateAppBuildSettingsRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	132, // 65: porter.v1.UpdateAppBuildSettingsRequest.build:type_name -> porter.v1.Build
	127, // 66: porter.v1.AppHelmValuesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 67: porter.v1.ManualServiceRunRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	29,  // 68: porter.v1.ImagesResponse.images:type_name -> porter.v1.ImageInfo
	127, // 69: porter.v1.CreateAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 70: porter.v1.DeleteAppInstanceRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	127, // 71: porter.v1.ListAppInstancesRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	98,  // 72: porter.v1.ListAppInstancesResponse.app_instances:type_name -> porter.v1.AppInstance
	127, // 73: porter.v1.CreateNotificationRequest.deployment_target_identifier:type_name -> porter.v1.DeploymentTargetIdentifier
	133, // 74: porter.v1.AssumeRoleChainTargetsResponse.chain_links:type_name -> porter.v1.AssumeRoleChainLink
	124, // 75: porter.v1.ECRTokenForRegistryResponse.expiry:type_name -> google.protobuf.Timestamp
	118, // 76: porter.v1.ClusterNetworkSettingsResponse.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	134, // 77: porter.v1.ClusterNetworkSettingsResponse.eks_cloud_provider_network:type_name -> porter.v1.AWSVpc
	4,   // 78: porter.v1.DatastoreStatusRequest.type:type_name -> porter.v1.EnumDatastore
	121, // 79: porter.v1.PreflightCheckResponse.PreflightChecksEntry.value:type_name -> porter.v1.Error
	5,   // 80: porter.v1.ClusterControlPlaneService.QuotaIncrease:input_type -> porter.v1.QuotaIncreaseRequest
	135, // 81: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:input_type -> porter.v1.UpdateCloudProviderCredentialsRequest
	...
	6,   // 133: porter.v1.ClusterControlPlaneService.QuotaIncrease:output_type -> porter.v1.QuotaIncreaseResponse
	136, // 134: porter.v1.ClusterControlPlaneService.UpdateCloudProviderCredentials:output_type -> porter.v1.UpdateCloudProviderCredentialsResponse
	10,  // 135: porter.v1.ClusterControlPlaneService.QuotaPreflightCheck:output_type -> porter.v1.QuotaPreflightCheckResponse
	8,   // 136: porter.v1.ClusterControlPlaneService.PreflightCheck:output_type -> porter.v1.PreflightCheckResponse
	12,  // 137: porter.v1.ClusterControlPlaneService.CreateAssumeRoleChain:output_type -> porter.v1.CreateAssumeRoleChainResponse
	14,  // 138: porter.v1.ClusterControlPlaneService.SaveAzureCredentials:output_type -> porter.v1.SaveAzureCredentialsResponse
	16,  // 139: porter.v1.ClusterControlPlaneService.KubeConfigForCluster:output_type -> porter.v1.KubeConfigForClusterResponse
	18,  // 140: porter.v1.ClusterControlPlaneService.UpdateContract:output_type -> porter.v1.UpdateContractResponse
	34,  // 141: porter.v1.ClusterControlPlaneService.ReadContract:output_type -> porter.v1.ReadContractResponse
	20,  // 142: porter.v1.ClusterControlPlaneService.ClusterStatus:output_type -> porter.v1.ClusterStatusResponse
	22,  // 143: porter.v1.ClusterControlPlaneService.DeleteCluster:output_type -> porter.v1.DeleteClusterResponse
	32,  // 144: porter.v1.ClusterControlPlaneService.TokenForRegistry:output_type -> porter.v1.TokenForRegistryResponse
	36,  // 145: porter.v1.ClusterControlPlaneService.ValidatePorterApp:output_type -> porter.v1.ValidatePorterAppResponse
	38,  // 146: porter.v1.ClusterControlPlaneService.ApplyPorterApp:output_type -> porter.v1.ApplyPorterAppResponse
	40,  // 147: porter.v1.ClusterControlPlaneService.UpdateApp:output_type -> porter.v1.UpdateAppResponse
	44,  // 148: porter.v1.ClusterControlPlaneService.RollbackRevision:output_type -> porter.v1.RollbackRevisionResponse
	42,  // 149: porter.v1.ClusterControlPlaneService.UpdateRevisionStatus:output_type -> porter.v1.UpdateRevisionStatusResponse
	46,  // 150: porter.v1.ClusterControlPlaneService.DeletePorterApp:output_type -> porter.v1.DeletePorterAppResponse
	48,  // 151: porter.v1.ClusterControlPlaneService.DeleteAppDeployment:output_type -> porter.v1.DeleteAppDeploymentResponse
	50,  // 152: porter.v1.ClusterControlPlaneService.DeleteDeploymentTarget:output_type -> porter.v1.DeleteDeploymentTargetResponse
	55,  // 153: porter.v1.ClusterControlPlaneService.CurrentAppRevision:output_type -> porter.v1.CurrentAppRevisionResponse
	57,  // 154: porter.v1.ClusterControlPlaneService.ListAppRevisions:output_type -> porter.v1.ListAppRevisionsResponse
	59,  // 155: porter.v1.ClusterControlPlaneService.LatestAppRevisions:output_type -> porter.v1.LatestAppRevisionsResponse
	61,  // 156: porter.v1.ClusterControlPlaneService.GetAppRevision:output_type -> porter.v1.GetAppRevisionResponse
	63,  // 157: porter.v1.ClusterControlPlaneService.AppTemplate:output_type -> porter.v1.AppTemplateResponse
	65,  // 158: porter.v1.ClusterControlPlaneService.PredeployStatus:output_type -> porter.v1.PredeployStatusResponse
	67,  // 159: porter.v1.ClusterControlPlaneService.DeploymentTargetDetails:output_type -> porter.v1.DeploymentTargetDetailsResponse
	69,  // 160: porter.v1.ClusterControlPlaneService.CreateDeploymentTarget:output_type -> porter.v1.CreateDeploymentTargetResponse
	71,  // 161: porter.v1.ClusterControlPlaneService.DeploymentTargets:output_type -> porter.v1.DeploymentTargetsResponse
	73,  // 162: porter.v1.ClusterControlPlaneService.DefaultDeploymentTarget:output_type -> porter.v1.DefaultDeploymentTargetResponse
	75,  // 163: porter.v1.ClusterControlPlaneService.SeedAppRevisions:output_type -> porter.v1.SeedAppRevisionsResponse
	77,  // 164: porter.v1.ClusterControlPlaneService.EnvGroupVariables:output_type -> porter.v1.EnvGroupVariablesResponse
	79,  // 165: porter.v1.ClusterControlPlaneService.LatestEnvGroupWithVariables:output_type -> porter.v1.LatestEnvGroupWithVariablesResponse
	81,  // 166: porter.v1.ClusterControlPlaneService.UpdateAppImage:output_type -> porter.v1.UpdateAppImageResponse
	83,  // 167: porter.v1.ClusterControlPlaneService.UpdateAppBuildSettings:output_type -> porter.v1.UpdateAppBuildSettingsResponse
	85,  // 168: porter.v1.ClusterControlPlaneService.UpdateAppsLinkedToEnvGroup:output_type -> porter.v1.UpdateAppsLinkedToEnvGroupResponse
	87,  // 169: porter.v1.ClusterControlPlaneService.AppHelmValues:output_type -> porter.v1.AppHelmValuesResponse
	89,  // 170: porter.v1.ClusterControlPlaneService.ManualServiceRun:output_type -> porter.v1.ManualServiceRunResponse
	114, // 171: porter.v1.ClusterControlPlaneService.ClusterNetworkSettings:output_type -> porter.v1.ClusterNetworkSettingsResponse
	91,  // 172: porter.v1.ClusterControlPlaneService.Images:output_type -> porter.v1.ImagesResponse
	93,  // 173: porter.v1.ClusterControlPlaneService.CreateAppInstance:output_type -> porter.v1.CreateAppInstanceResponse
	95,  // 174: porter.v1.ClusterControlPlaneService.DeleteAppInstance:output_type -> porter.v1.DeleteAppInstanceResponse
	97,  // 175: porter.v1.ClusterControlPlaneService.ListAppInstances:output_type -> porter.v1.ListAppInstancesResponse
	100, // 176: porter.v1.ClusterControlPlaneService.CreateNotification:output_type -> porter.v1.CreateNotificationResponse
	112, // 177: porter.v1.ClusterControlPlaneService.DockerConfigFileForRegistry:output_type -> porter.v1.DockerConfigFileForRegistryResponse
	108, // 178: porter.v1.ClusterControlPlaneService.ECRTokenForRegistry:output_type -> porter.v1.ECRTokenForRegistryResponse
	110, // 179: porter.v1.ClusterControlPlaneService.AssumeRoleCredentials:output_type -> porter.v1.AssumeRoleCredentialsResponse
	106, // 180: porter.v1.ClusterControlPlaneService.AssumeRoleChainTargets:output_type -> porter.v1.AssumeRoleChainTargetsResponse
	104, // 181: porter.v1.ClusterControlPlaneService.CertificateAuthorityData:output_type -> porter.v1.CertificateAuthorityDataResponse
	102, // 182: porter.v1.ClusterControlPlaneService.EKSBearerToken:output_type -> porter.v1.EKSBearerTokenResponse
	24,  // 183: porter.v1.ClusterControlPlaneService.ListRepositoriesForRegistry:output_type -> porter.v1.ListRepositoriesForRegistryResponse
	27,  // 184: porter.v1.ClusterControlPlaneService.ListImagesForRepository:output_type -> porter.v1.ListImagesForRepositoryResponse
	116, // 185: porter.v1.ClusterControlPlaneService.DatastoreStatus:output_type -> porter.v1.DatastoreStatusResponse
	133, // [133:186] is the sub-list for method output_type
	80,  // [80:133] is the sub-list for method input_type
