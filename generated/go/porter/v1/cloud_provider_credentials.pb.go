...
type CloudProviderPermissionsStatusRequest struct {
	...
	// Types that are assignable to CloudProviderCredentials:
	//
	//	*CloudProviderPermissionsStatusRequest_AwsCredentials
	//	*CloudProviderPermissionsStatusRequest_AzureCredentials
	//	*CloudProviderPermissionsStatusRequest_GcpCredentials
	CloudProviderCredentials isCloudProviderPermissionsStatusRequest_CloudProviderCredentials `protobuf_oneof:"cloud_provider_credentials"`
}
...
func (m *CloudProviderPermissionsStatusRequest) GetCloudProviderCredentials() isCloudProviderPermissionsStatusRequest_CloudProviderCredentials {
	if m != nil {
		return m.CloudProviderCredentials
	}
	return nil
...
func (x *CloudProviderPermissionsStatusRequest) GetAwsCredentials() *AWSCredentials {
	if x, ok := x.GetCloudProviderCredentials().(*CloudProviderPermissionsStatusRequest_AwsCredentials); ok {
		return x.AwsCredentials
	}
	return nil
}

func (x *CloudProviderPermissionsStatusRequest) GetAzureCredentials() *AzureCredentials {
	if x, ok := x.GetCloudProviderCredentials().(*CloudProviderPermissionsStatusRequest_AzureCredentials); ok {
		return x.AzureCredentials
	}
	return nil
}

func (x *CloudProviderPermissionsStatusRequest) GetGcpCredentials() *GCPCredentials {
	if x, ok := x.GetCloudProviderCredentials().(*CloudProviderPermissionsStatusRequest_GcpCredentials); ok {
		return x.GcpCredentials
	}
	return nil
}

type isCloudProviderPermissionsStatusRequest_CloudProviderCredentials interface {
	isCloudProviderPermissionsStatusRequest_CloudProviderCredentials()
}

type CloudProviderPermissionsStatusRequest_AwsCredentials struct {
	AwsCredentials *AWSCredentials `protobuf:"bytes,3,opt,name=aws_credentials,json=awsCredentials,proto3,oneof"`
}

type CloudProviderPermissionsStatusRequest_AzureCredentials struct {
	AzureCredentials *AzureCredentials `protobuf:"bytes,4,opt,name=azure_credentials,json=azureCredentials,proto3,oneof"`
}

type CloudProviderPermissionsStatusRequest_GcpCredentials struct {
	GcpCredentials *GCPCredentials `protobuf:"bytes,5,opt,name=gcp_credentials,json=gcpCredentials,proto3,oneof"`
}

func (*CloudProviderPermissionsStatusRequest_AwsCredentials) isCloudProviderPermissionsStatusRequest_CloudProviderCredentials() {
}

func (*CloudProviderPermissionsStatusRequest_AzureCredentials) isCloudProviderPermissionsStatusRequest_CloudProviderCredentials() {
}

func (*CloudProviderPermissionsStatusRequest_GcpCredentials) isCloudProviderPermissionsStatusRequest_CloudProviderCredentials() {
}
...
var file_porter_v1_cloud_provider_credentials_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x22, 0x81, 0x03, 0x0a, 0x25, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x50, 0x72, 0x6f, 0x76,
	...
	,
	...
	0x6c, 0x65, 0x74, 0x65, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x10, 0x70, 0x65, 0x72,
	0x63, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x42, 0xb8, 0x01,
	0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42,
	0x1d, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x43, 0x72,
...
var file_porter_v1_cloud_provider_credentials_proto_depIdxs = []int32{
	...
	0, // 5: porter.v1.CloudProviderPermissionsStatusRequest.aws_credentials:type_name -> porter.v1.AWSCredentials
	1, // 6: porter.v1.CloudProviderPermissionsStatusRequest.azure_credentials:type_name -> porter.v1.AzureCredentials
	2, // 7: porter.v1.CloudProviderPermissionsStatusRequest.gcp_credentials:type_name -> porter.v1.GCPCredentials
...
func file_porter_v1_cloud_provider_credentials_proto_init() {
	...
	file_porter_v1_cloud_provider_credentials_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*CloudProviderPermissionsStatusRequest_AwsCredentials)(nil),
		(*CloudProviderPermissionsStatusRequest_AzureCredentials)(nil),
		(*CloudProviderPermissionsStatusRequest_GcpCredentials)(nil),
	}
	type x struct{}
