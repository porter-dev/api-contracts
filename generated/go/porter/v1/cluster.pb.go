...
type UserNodeGroup struct {
	...
	CpuCores float32 `protobuf:"fixed32,5,opt,name=cpu_cores,json=cpuCores,proto3" json:"cpu_cores,omitempty"`
	// gpu_cores is the number of gpu cores available for the node group
	GpuCores int32 `protobuf:"varint,6,opt,name=gpu_cores,json=gpuCores,proto3" json:"gpu_cores,omitempty"`
}

func (x *UserNodeGroup) Reset() {
	*x = UserNodeGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_cluster_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *UserNodeGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserNodeGroup) ProtoMessage() {}

func (x *UserNodeGroup) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_cluster_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserNodeGroup.ProtoReflect.Descriptor instead.
func (*UserNodeGroup) Descriptor() ([]byte, []int) {
	return file_porter_v1_cluster_proto_rawDescGZIP(), []int{1}
}

func (x *UserNodeGroup) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *UserNodeGroup) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UserNodeGroup) GetInstanceType() string {
	if x != nil {
...
func (x *UserNodeGroup) GetRamMb() int32 {
	if x != nil {
		return x.RamMb
	}
	return 0
...
func (x *UserNodeGroup) GetCpuCores() float32 {
	if x != nil {
		return x.CpuCores
	}
	return 0
...
func (x *UserNodeGroup) GetGpuCores() int32 {
	if x != nil {
		return x.GpuCores
	}
	return 0
...
var file_porter_v1_cluster_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x0b, 0x6b, 0x69, 0x6e, 0x64, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x22, 0xa9,
	0x01, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x6f, 0x64, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70,
	...
	,
...
var file_porter_v1_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_porter_v1_cluster_proto_goTypes = []any{
	...
	(*UserNodeGroup)(nil),   // 3: porter.v1.UserNodeGroup
	(*EKS)(nil),             // 4: porter.v1.EKS
	(*GKE)(nil),             // 5: porter.v1.GKE
	(*AKS)(nil),             // 6: porter.v1.AKS
}
var file_porter_v1_cluster_proto_depIdxs = []int32{
	...
	4, // 2: porter.v1.Cluster.eks_kind:type_name -> porter.v1.EKS
	5, // 3: porter.v1.Cluster.gke_kind:type_name -> porter.v1.GKE
	6, // 4: porter.v1.Cluster.aks_kind:type_name -> porter.v1.AKS
...
func file_porter_v1_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_cluster_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_porter_v1_cluster_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*UserNodeGroup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_porter_v1_cluster_proto_msgTypes[0].OneofWrappers = []any{
		(*Cluster_EksKind)(nil),
		(*Cluster_GkeKind)(nil),
		(*Cluster_AksKind)(nil),
	}
