...
var file_porter_v1_porter_app_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x74, 0x61, 0x67, 0x42, 0xa9, 0x01, 0x0a, 0x0d, 0x63, 0x6f,
	0x6d, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0e, 0x50, 0x6f, 0x72,
	0x74, 0x65, 0x72, 0x41, 0x70, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x43, 0x67,
...
var file_porter_v1_porter_app_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_porter_v1_porter_app_proto_goTypes = []interface{}{
	...
	(*ServiceDeletions)(nil),  // 3: porter.v1.ServiceDeletions
	(*Deletions)(nil),         // 4: porter.v1.Deletions
	(*DomainNameList)(nil),    // 5: porter.v1.DomainNameList
	(*Build)(nil),             // 6: porter.v1.Build
	(*AppImage)(nil),          // 7: porter.v1.AppImage
	nil,                       // 8: porter.v1.PorterApp.ServicesEntry
	nil,                       // 9: porter.v1.PorterApp.EnvEntry
	nil,                       // 10: porter.v1.EnvGroupVariables.NormalEntry
	nil,                       // 11: porter.v1.EnvGroupVariables.SecretEntry
	nil,                       // 12: porter.v1.Deletions.ServiceDomainsEntry
	nil,                       // 13: porter.v1.Deletions.ServiceDeletionsEntry
	(*Service)(nil),           // 14: porter.v1.Service
}
var file_porter_v1_porter_app_proto_depIdxs = []int32{
	8,  // 0: porter.v1.PorterApp.services:type_name -> porter.v1.PorterApp.ServicesEntry
	9,  // 1: porter.v1.PorterApp.env:type_name -> porter.v1.PorterApp.EnvEntry
	6,  // 2: porter.v1.PorterApp.build:type_name -> porter.v1.Build
	14, // 3: porter.v1.PorterApp.predeploy:type_name -> porter.v1.Service
	7,  // 4: porter.v1.PorterApp.image:type_name -> porter.v1.AppImage
	1,  // 5: porter.v1.PorterApp.env_groups:type_name -> porter.v1.EnvGroup
	10, // 6: porter.v1.EnvGroupVariables.normal:type_name -> porter.v1.EnvGroupVariables.NormalEntry
	11, // 7: porter.v1.EnvGroupVariables.secret:type_name -> porter.v1.EnvGroupVariables.SecretEntry
	12, // 8: porter.v1.Deletions.service_domains:type_name -> porter.v1.Deletions.ServiceDomainsEntry
	13, // 9: porter.v1.Deletions.service_deletions:type_name -> porter.v1.Deletions.ServiceDeletionsEntry
	14, // 10: porter.v1.PorterApp.ServicesEntry.value:type_name -> porter.v1.Service
	5,  // 11: porter.v1.Deletions.ServiceDomainsEntry.value:type_name -> porter.v1.DomainNameList
	3,  // 12: porter.v1.Deletions.ServiceDeletionsEntry.value:type_name -> porter.v1.ServiceDeletions
