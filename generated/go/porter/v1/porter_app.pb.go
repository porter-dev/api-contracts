...
type PorterApp struct {
	...
	Release  *Service            `protobuf:"bytes,5,opt,name=release,proto3" json:"release,omitempty"`
...
func (x *PorterApp) GetRelease() *Service {
	if x != nil {
		return x.Release
	}
	return nil
...
func (x *PorterAppRevision) Reset() {
	*x = PorterAppRevision{}
	if protoimpl.UnsafeEnabled {
...
func (x *PorterAppRevision) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PorterAppRevision) ProtoMessage() {}

func (x *PorterAppRevision) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_porter_app_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PorterAppRevision.ProtoReflect.Descriptor instead.
func (*PorterAppRevision) Descriptor() ([]byte, []int) {
	return file_porter_v1_porter_app_proto_rawDescGZIP(), []int{3}
}

func (x *PorterAppRevision) GetProjectId() int32 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *PorterAppRevision) GetRevisionId() string {
	if x != nil {
		return x.RevisionId
	}
	return ""
...
var file_porter_v1_porter_app_proto_rawDesc = []byte{
	...
	0x22, 0x9a, 0x03, 0x0a, 0x09, 0x50, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x41, 0x70, 0x70, 0x12, 0x12,
	...
	0x75, 0x69, 0x6c, 0x64, 0x52, 0x05, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x12, 0x2c, 0x0a, 0x07, 0x72,
	0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x70,
	0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x52, 0x07, 0x72, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x12, 0x29, 0x0a, 0x05, 0x69, 0x6d, 0x61,
	...
	0x6d, 0x61, 0x67, 0x65, 0x1a, 0x4f, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x36, 0x0a, 0x08, 0x45, 0x6e, 0x76, 0x45, 0x6e, 0x74, 0x72,
	...
	0x69, 0x6c, 0x65, 0x22, 0x3c, 0x0a, 0x08, 0x41, 0x70, 0x70, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x12,
	...
	0x67, 0x22, 0x53, 0x0a, 0x11, 0x50, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x41, 0x70, 0x70, 0x52, 0x65,
	0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x42, 0xa9, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70,
...
var file_porter_v1_porter_app_proto_goTypes = []interface{}{
	...
	(*PorterAppRevision)(nil), // 3: porter.v1.PorterAppRevision
...
var file_porter_v1_porter_app_proto_depIdxs = []int32{
	...
	6, // 3: porter.v1.PorterApp.release:type_name -> porter.v1.Service
...
func file_porter_v1_porter_app_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_porter_v1_porter_app_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PorterAppRevision); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
