...
type MessageSystemInfrastructure struct {
...
func (x *MessageSystemInfrastructure) Reset() {
	*x = MessageSystemInfrastructure{}
...
func (x *MessageSystemInfrastructure) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageSystemInfrastructure) ProtoMessage() {}

func (x *MessageSystemInfrastructure) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_status_messages_proto_msgTypes[0]
...
// Deprecated: Use MessageSystemInfrastructure.ProtoReflect.Descriptor instead.
func (*MessageSystemInfrastructure) Descriptor() ([]byte, []int) {
	return file_porter_v1_status_messages_proto_rawDescGZIP(), []int{0}
}

func (x *MessageSystemInfrastructure) GetClusterId() int32 {
	if x != nil {
		return x.ClusterId
	}
	return 0
...
func (x *MessageSystemInfrastructure) GetProjectId() int32 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *MessageSystemInfrastructure) GetIsError() bool {
	if x != nil {
		return x.IsError
	}
	return false
...
func (x *MessageSystemInfrastructure) GetIsRetryable() bool {
	if x != nil {
...
func (x *MessageSystemInfrastructure) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_porter_v1_status_messages_proto_rawDesc = []byte{
	...
	,
...
var file_porter_v1_status_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_porter_v1_status_messages_proto_goTypes = []interface{}{
	(*MessageSystemInfrastructure)(nil), // 0: porter.v1.MessageSystemInfrastructure
}
...
func file_porter_v1_status_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_status_messages_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageSystemInfrastructure); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
