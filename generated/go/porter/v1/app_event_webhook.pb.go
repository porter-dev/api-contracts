...
type AppEventWebhook struct {
	...
	PayloadEncryptionKey string `protobuf:"bytes,4,opt,name=payload_encryption_key,json=payloadEncryptionKey,proto3" json:"payload_encryption_key,omitempty"`
}
...
func (x *AppEventWebhook) GetWebhookUrl() string {
	if x != nil {
		return x.WebhookUrl
	}
	return ""
...
func (x *AppEventWebhook) GetPayloadEncryptionKey() string {
	if x != nil {
...
var file_porter_v1_app_event_webhook_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x14, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x45, 0x6e,
...
var file_porter_v1_app_event_webhook_proto_goTypes = []any{
...
func file_porter_v1_app_event_webhook_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_app_event_webhook_proto_msgTypes[0].Exporter = func(v any, i int) any {
