...
var file_porter_v1_prometheus_alerts_proto_goTypes = []any{
...
func file_porter_v1_prometheus_alerts_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_prometheus_alerts_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Alert); i {
			case 0:
				return &v.state
			case 1:
	...
	file_porter_v1_prometheus_alerts_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
