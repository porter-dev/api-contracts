...
const (
	...
	ClusterHealthType_CLUSTER_HEALTH_TYPE_METRICS ClusterHealthType = 3
)
...
func (x *ServiceStatusHistory) Reset() {
	*x = ServiceStatusHistory{}
	if protoimpl.UnsafeEnabled {
...
func (x *ServiceStatusHistory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServiceStatusHistory) ProtoMessage() {}

func (x *ServiceStatusHistory) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_system_service_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServiceStatusHistory.ProtoReflect.Descriptor instead.
func (*ServiceStatusHistory) Descriptor() ([]byte, []int) {
	return file_porter_v1_system_service_proto_rawDescGZIP(), []int{4}
}

func (x *ServiceStatusHistory) GetSystemService() *SystemService {
	if x != nil {
...
func (x *ServiceStatusHistory) GetDailyStatusHistory() map[int32]*DailyHealthStatus {
	if x != nil {
...
type ClusterStatusHistory struct {
	...
	// status_percentages holds information on what percentage of the day different statuses were observed
	// there should be only one entry for the different Status types
	StatusPercentages []*StatusPercentage `protobuf:"bytes,2,rep,name=status_percentages,json=statusPercentages,proto3" json:"status_percentages,omitempty"`
	// daily_status_history is daily health status for the cluster over multiple days for the cluster_health_type
	// the keys are the number of days before today the DailyHealthStatus is from
	DailyStatusHistory []*DailyHealthStatus `protobuf:"bytes,3,rep,name=daily_status_history,json=dailyStatusHistory,proto3" json:"daily_status_history,omitempty"`
}
...
func (x *ClusterStatusHistory) GetStatusPercentages() []*StatusPercentage {
	if x != nil {
		return x.StatusPercentages
	}
	return nil
...
func (x *ClusterStatusHistory) GetDailyStatusHistory() []*DailyHealthStatus {
	if x != nil {
		return x.DailyStatusHistory
	}
	return nil
...
var file_porter_v1_system_service_proto_rawDesc = []byte{
	...
	,
	...
	0x55, 0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x55, 0x52, 0x45, 0x10, 0x03, 0x2a, 0x9e, 0x01, 0x0a,
	...
	0x45, 0x5f, 0x50, 0x49, 0x4e, 0x47, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x02, 0x12, 0x1f, 0x0a, 0x1b,
	0x43, 0x4c, 0x55, 0x53, 0x54, 0x45, 0x52, 0x5f, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x5f, 0x54,
	0x59, 0x50, 0x45, 0x5f, 0x4d, 0x45, 0x54, 0x52, 0x49, 0x43, 0x53, 0x10, 0x03, 0x42, 0xad, 0x01,
	0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42,
	0x12, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72,
...
var file_porter_v1_system_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_porter_v1_system_service_proto_goTypes = []interface{}{
	...
	(*ServiceStatusHistory)(nil),  // 6: porter.v1.ServiceStatusHistory
	(*ClusterStatusHistory)(nil),  // 7: porter.v1.ClusterStatusHistory
	nil,                           // 8: porter.v1.ServiceStatusHistory.DailyStatusHistoryEntry
	(InvolvedObjectType)(0),       // 9: porter.v1.InvolvedObjectType
	(*timestamppb.Timestamp)(nil), // 10: google.protobuf.Timestamp
}
var file_porter_v1_system_service_proto_depIdxs = []int32{
	9,  // 0: porter.v1.SystemService.involved_object_type:type_name -> porter.v1.InvolvedObjectType
	10, // 1: porter.v1.HealthStatus.start_time:type_name -> google.protobuf.Timestamp
	10, // 2: porter.v1.HealthStatus.end_time:type_name -> google.protobuf.Timestamp
	...
	2,  // 7: porter.v1.ServiceStatusHistory.system_service:type_name -> porter.v1.SystemService
	8,  // 8: porter.v1.ServiceStatusHistory.daily_status_history:type_name -> porter.v1.ServiceStatusHistory.DailyStatusHistoryEntry
	1,  // 9: porter.v1.ClusterStatusHistory.cluster_health_type:type_name -> porter.v1.ClusterHealthType
	4,  // 10: porter.v1.ClusterStatusHistory.status_percentages:type_name -> porter.v1.StatusPercentage
	5,  // 11: porter.v1.ClusterStatusHistory.daily_status_history:type_name -> porter.v1.DailyHealthStatus
	5,  // 12: porter.v1.ServiceStatusHistory.DailyStatusHistoryEntry.value:type_name -> porter.v1.DailyHealthStatus
...
func file_porter_v1_system_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_porter_v1_system_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServiceStatusHistory); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
