...
const (
	...
	EnumDatastoreKind_ENUM_DATASTORE_KIND_NEON          EnumDatastoreKind = 5
	EnumDatastoreKind_ENUM_DATASTORE_KIND_UPSTASH       EnumDatastoreKind = 6
)
...
var (
	EnumDatastoreKind_name = map[int32]string{
		...
		5: "ENUM_DATASTORE_KIND_NEON",
		6: "ENUM_DATASTORE_KIND_UPSTASH",
	}
...
type ManagedDatastore struct {
	...
	//	*ManagedDatastore_NeonKind
	//	*ManagedDatastore_UpstashKind
	...
	PublicNetworking *PublicNetworking `protobuf:"bytes,14,opt,name=public_networking,json=publicNetworking,proto3" json:"public_networking,omitempty"`
}
...
func (x *ManagedDatastore) GetNeonKind() *Neon {
	if x, ok := x.GetKindValues().(*ManagedDatastore_NeonKind); ok {
		return x.NeonKind
	}
	return nil
}

func (x *ManagedDatastore) GetUpstashKind() *Upstash {
	if x, ok := x.GetKindValues().(*ManagedDatastore_UpstashKind); ok {
		return x.UpstashKind
	}
	return nil
}
...
func (x *ManagedDatastore) GetPublicNetworking() *PublicNetworking {
	if x != nil {
...
type ManagedDatastore_NeonKind struct {
	NeonKind *Neon `protobuf:"bytes,12,opt,name=neon_kind,json=neonKind,proto3,oneof"`
}

type ManagedDatastore_UpstashKind struct {
	UpstashKind *Upstash `protobuf:"bytes,13,opt,name=upstash_kind,json=upstashKind,proto3,oneof"`
}
...
func (*ManagedDatastore_NeonKind) isManagedDatastore_KindValues() {}

func (*ManagedDatastore_UpstashKind) isManagedDatastore_KindValues() {}
...
type PublicNetworking struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// cidr_allowlist is a list of comma-separated CIDRS, which are supplemental ranges that are allowed access to the datastore
	CidrAllowlist []string `protobuf:"bytes,1,rep,name=cidr_allowlist,json=cidrAllowlist,proto3" json:"cidr_allowlist,omitempty"`
}

func (x *PublicNetworking) Reset() {
	*x = PublicNetworking{}
	if protoimpl.UnsafeEnabled {
...
func (x *PublicNetworking) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PublicNetworking) ProtoMessage() {}

func (x *PublicNetworking) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_datastore_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PublicNetworking.ProtoReflect.Descriptor instead.
func (*PublicNetworking) Descriptor() ([]byte, []int) {
	return file_porter_v1_datastore_proto_rawDescGZIP(), []int{2}
}

func (x *PublicNetworking) GetCidrAllowlist() []string {
	if x != nil {
		return x.CidrAllowlist
	}
	return nil
}
...
func (x *Neon) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Neon) ProtoMessage() {}

func (x *Neon) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_datastore_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Neon.ProtoReflect.Descriptor instead.
func (*Neon) Descriptor() ([]byte, []int) {
...
func (x *Upstash) Reset() {
	*x = Upstash{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_datastore_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Upstash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Upstash) ProtoMessage() {}

func (x *Upstash) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_datastore_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Upstash.ProtoReflect.Descriptor instead.
func (*Upstash) Descriptor() ([]byte, []int) {
	return file_porter_v1_datastore_proto_rawDescGZIP(), []int{7}
}
...
func (x *UpdateDatastorePayload) Reset() {
	*x = UpdateDatastorePayload{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_datastore_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateDatastorePayload) Descriptor() ([]byte, []int) {
	return file_porter_v1_datastore_proto_rawDescGZIP(), []int{8}
}
...
func (x *DatastoreCredential) Reset() {
	*x = DatastoreCredential{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_datastore_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DatastoreCredential) Descriptor() ([]byte, []int) {
	return file_porter_v1_datastore_proto_rawDescGZIP(), []int{9}
}
...
var file_porter_v1_datastore_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8, 0x06, 0x0a, 0x10, 0x4d, 0x61, 0x6e, 0x61,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x01, 0x12, 0x3b, 0x0a, 0x06, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x23, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x45,
	0x6e, 0x75, 0x6d, 0x41, 0x77, 0x73, 0x45, 0x6c, 0x61, 0x73, 0x74, 0x69, 0x63, 0x61, 0x63, 0x68,
	...
	,
	...
	0x64, 0x22, 0x9a, 0x01, 0x0a, 0x13, 0x44, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x43,
	...
	0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x2a, 0x92,
	0x02, 0x0a, 0x11, 0x45, 0x6e, 0x75, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65,
	0x4b, 0x69, 0x6e, 0x64, 0x12, 0x23, 0x0a, 0x1f, 0x45, 0x4e, 0x55, 0x4d, 0x5f, 0x44, 0x41, 0x54,
	0x41, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x55, 0x4e, 0x53, 0x50,
	...
	,
...
var file_porter_v1_datastore_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_porter_v1_datastore_proto_goTypes = []any{
	...
	(*PublicNetworking)(nil),           // 5: porter.v1.PublicNetworking
	(*DatastorePasswordSecretRef)(nil), // 6: porter.v1.DatastorePasswordSecretRef
	(*AwsRds)(nil),                     // 7: porter.v1.AwsRds
	(*AwsElasticache)(nil),             // 8: porter.v1.AwsElasticache
	(*Neon)(nil),                       // 9: porter.v1.Neon
	(*Upstash)(nil),                    // 10: porter.v1.Upstash
	(*UpdateDatastorePayload)(nil),     // 11: porter.v1.UpdateDatastorePayload
	(*DatastoreCredential)(nil),        // 12: porter.v1.DatastoreCredential
	(EnumCloudProvider)(0),             // 13: porter.v1.EnumCloudProvider
	(*Postgres)(nil),                   // 14: porter.v1.Postgres
	(*Redis)(nil),                      // 15: porter.v1.Redis
}
var file_porter_v1_datastore_proto_depIdxs = []int32{
	13, // 0: porter.v1.ManagedDatastore.cloud_provider:type_name -> porter.v1.EnumCloudProvider
	0,  // 1: porter.v1.ManagedDatastore.kind:type_name -> porter.v1.EnumDatastoreKind
	7,  // 2: porter.v1.ManagedDatastore.aws_rds_kind:type_name -> porter.v1.AwsRds
	8,  // 3: porter.v1.ManagedDatastore.aws_elasticache_kind:type_name -> porter.v1.AwsElasticache
	14, // 4: porter.v1.ManagedDatastore.managed_postgres_kind:type_name -> porter.v1.Postgres
	15, // 5: porter.v1.ManagedDatastore.managed_redis_kind:type_name -> porter.v1.Redis
	9,  // 6: porter.v1.ManagedDatastore.neon_kind:type_name -> porter.v1.Neon
	10, // 7: porter.v1.ManagedDatastore.upstash_kind:type_name -> porter.v1.Upstash
	4,  // 8: porter.v1.ManagedDatastore.connected_clusters:type_name -> porter.v1.ConnectedClusters
	5,  // 9: porter.v1.ManagedDatastore.public_networking:type_name -> porter.v1.PublicNetworking
	6,  // 10: porter.v1.AwsRds.master_user_password_secret_ref:type_name -> porter.v1.DatastorePasswordSecretRef
	1,  // 11: porter.v1.AwsRds.engine:type_name -> porter.v1.EnumAwsRdsEngine
	2,  // 12: porter.v1.AwsElasticache.engine:type_name -> porter.v1.EnumAwsElasticacheEngine
...
func file_porter_v1_datastore_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_datastore_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_porter_v1_datastore_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_porter_v1_datastore_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*PublicNetworking); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_porter_v1_datastore_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_porter_v1_datastore_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*AwsRds); i {
			case 0:
				return &v.state
			case 1:
		...
		file_porter_v1_datastore_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_porter_v1_datastore_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Neon); i {
			case 0:
				return &v.state
			case 1:
		...
		file_porter_v1_datastore_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Upstash); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_porter_v1_datastore_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_porter_v1_datastore_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_porter_v1_datastore_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*ManagedDatastore_NeonKind)(nil),
		(*ManagedDatastore_UpstashKind)(nil),
	}
	file_porter_v1_datastore_proto_msgTypes[4].OneofWrappers = []any{}
	file_porter_v1_datastore_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
