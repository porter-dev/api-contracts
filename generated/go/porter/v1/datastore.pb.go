...
type UpdateDatastorePaylod struct {
...
func (x *UpdateDatastorePaylod) Reset() {
	*x = UpdateDatastorePaylod{}
...
func (x *UpdateDatastorePaylod) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateDatastorePaylod) ProtoMessage() {}

func (x *UpdateDatastorePaylod) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_datastore_proto_msgTypes[0]
...
// Deprecated: Use UpdateDatastorePaylod.ProtoReflect.Descriptor instead.
func (*UpdateDatastorePaylod) Descriptor() ([]byte, []int) {
	return file_porter_v1_datastore_proto_rawDescGZIP(), []int{0}
}

func (x *UpdateDatastorePaylod) GetProjectId() int64 {
	if x != nil {
		return x.ProjectId
	}
	return 0
...
func (x *UpdateDatastorePaylod) GetDatastoreId() string {
	if x != nil {
...
var file_porter_v1_datastore_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0x59, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x44, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x64, 0x12,
	...
	0x64, 0x42, 0xa9, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72,
	0x2e, 0x76, 0x31, 0x42, 0x0e, 0x44, 0x61, 0x74, 0x61, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x50, 0x72,
...
var file_porter_v1_datastore_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_porter_v1_datastore_proto_goTypes = []interface{}{
	(*UpdateDatastorePaylod)(nil), // 0: porter.v1.UpdateDatastorePaylod
}
...
func file_porter_v1_datastore_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_datastore_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateDatastorePaylod); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
