...
const (
	...
	EnumDatastoreKind_ENUM_DATASTORE_KIND_RDS_POSTGRES EnumDatastoreKind = 1
)
...
var (
	EnumDatastoreKind_name = map[int32]string{
		...
		1: "ENUM_DATASTORE_KIND_RDS_POSTGRES",
	}
...
type PorterDatastore struct {
	...
	Kind EnumDatastoreKind `protobuf:"varint,4,opt,name=kind,proto3,enum=porter.v1.EnumDatastoreKind" json:"kind,omitempty"`
	// kind_values are the required values depending on kind
	//
	// Types that are assignable to KindValues:
	//
	//	*PorterDatastore_RdsPostgresKind
...
func (x *PorterDatastore) GetRdsPostgresKind() *RdsPostgres {
	if x, ok := x.GetKindValues().(*PorterDatastore_RdsPostgresKind); ok {
		return x.RdsPostgresKind
	}
	return nil
}
...
type PorterDatastore_RdsPostgresKind struct {
	RdsPostgresKind *RdsPostgres `protobuf:"bytes,5,opt,name=rds_postgres_kind,json=rdsPostgresKind,proto3,oneof"`
}

func (*PorterDatastore_RdsPostgresKind) isPorterDatastore_KindValues() {}
...
type RdsPostgres struct {
	...
	MasterUsername string `protobuf:"bytes,3,opt,name=master_username,json=masterUsername,proto3" json:"master_username,omitempty"`
	...
	MasterUserPasswordLiteral string `protobuf:"bytes,4,opt,name=master_user_password_literal,json=masterUserPasswordLiteral,proto3" json:"master_user_password_literal,omitempty"`
	// master_user_password_secret_ref is the reference to the secret that stores the password of the database
	MasterUserPasswordSecretRef *DatastorePasswordSecretRef `protobuf:"bytes,5,opt,name=master_user_password_secret_ref,json=masterUserPasswordSecretRef,proto3" json:"master_user_password_secret_ref,omitempty"`
	// allocated_storage_gigabytes is the allocated storage of the database in gigabytes
	AllocatedStorageGigabytes int64 `protobuf:"varint,6,opt,name=allocated_storage_gigabytes,json=allocatedStorageGigabytes,proto3" json:"allocated_storage_gigabytes,omitempty"`
...
func (x *RdsPostgres) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RdsPostgres) ProtoMessage() {}

func (x *RdsPostgres) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_datastore_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RdsPostgres.ProtoReflect.Descriptor instead.
func (*RdsPostgres) Descriptor() ([]byte, []int) {
	return file_porter_v1_datastore_proto_rawDescGZIP(), []int{2}
}

func (x *RdsPostgres) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RdsPostgres) GetDatabaseName() string {
	if x != nil {
...
func (x *RdsPostgres) GetMasterUsername() string {
	if x != nil {
...
func (x *RdsPostgres) GetMasterUserPasswordLiteral() string {
	if x != nil {
...
func (x *RdsPostgres) GetMasterUserPasswordSecretRef() *DatastorePasswordSecretRef {
	if x != nil {
...
func (x *RdsPostgres) GetAllocatedStorageGigabytes() int64 {
	if x != nil {
...
func (x *RdsPostgres) GetInstanceClass() string {
	if x != nil {
...
var file_porter_v1_datastore_proto_rawDesc = []byte{
	...
	0xbe, 0x02, 0x0a, 0x0f, 0x50, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x73, 0x74,
	...
	,
	...
	0x65, 0x79, 0x22, 0x84, 0x03, 0x0a, 0x0b, 0x52, 0x64, 0x73, 0x50, 0x6f, 0x73, 0x74, 0x67, 0x72,
	0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	...
	0x61, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03,
	...
	,
	...
	0x6f, 0x72, 0x65, 0x49, 0x64, 0x22, 0x9a, 0x01, 0x0a, 0x13, 0x44, 0x61, 0x74, 0x61, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x43, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x12, 0x12, 0x0a,
	...
	0x73, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e, 0x61,
	...
	0x72, 0x74, 0x2a, 0x5e, 0x0a, 0x11, 0x45, 0x6e, 0x75, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x4b, 0x69, 0x6e, 0x64, 0x12, 0x23, 0x0a, 0x1f, 0x45, 0x4e, 0x55, 0x4d, 0x5f,
	0x44, 0x41, 0x54, 0x41, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x5f, 0x4b, 0x49, 0x4e, 0x44, 0x5f, 0x55,
	...
	0x49, 0x4e, 0x44, 0x5f, 0x52, 0x44, 0x53, 0x5f, 0x50, 0x4f, 0x53, 0x54, 0x47, 0x52, 0x45, 0x53,
	0x10, 0x01, 0x42, 0xa9, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65,
...
var file_porter_v1_datastore_proto_goTypes = []interface{}{
	...
	(*RdsPostgres)(nil),                // 3: porter.v1.RdsPostgres
...
var file_porter_v1_datastore_proto_depIdxs = []int32{
	...
	3, // 2: porter.v1.PorterDatastore.rds_postgres_kind:type_name -> porter.v1.RdsPostgres
	2, // 3: porter.v1.RdsPostgres.master_user_password_secret_ref:type_name -> porter.v1.DatastorePasswordSecretRef
...
func file_porter_v1_datastore_proto_init() {
	...
	file_porter_v1_datastore_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*PorterDatastore_RdsPostgresKind)(nil),
	}
	type x struct{}
