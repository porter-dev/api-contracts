...
var file_porter_v1_cloud_contract_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42,
	0xad, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x42, 0x12, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74,
...
var file_porter_v1_cloud_contract_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_porter_v1_cloud_contract_proto_goTypes = []interface{}{
	...
	(*ManagedDatastore)(nil),              // 4: porter.v1.ManagedDatastore
	(*Addon)(nil),                         // 5: porter.v1.Addon
}
var file_porter_v1_cloud_contract_proto_depIdxs = []int32{
	4, // 0: porter.v1.CloudContract.datastores:type_name -> porter.v1.ManagedDatastore
	1, // 1: porter.v1.CloudContract.addons:type_name -> porter.v1.CloudContractAddon
	5, // 2: porter.v1.CloudContractAddon.addon:type_name -> porter.v1.Addon
