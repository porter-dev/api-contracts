...
var file_porter_v1_aks_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
...
var file_porter_v1_aks_proto_goTypes = []any{
...
func file_porter_v1_aks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_aks_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AKS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_porter_v1_aks_proto_msgTypes[1].Exporter = func(v any, i int) any {
