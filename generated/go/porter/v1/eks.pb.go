...
const (
	...
	NodeGroupType_NODE_GROUP_TYPE_USER NodeGroupType = 5
)
...
type EKS struct {
	...
	CidrRange       string          `protobuf:"bytes,3,opt,name=cidr_range,json=cidrRange,proto3" json:"cidr_range,omitempty"` // use network.vpc_cidr instead
	...
	Network *AWSClusterNetwork `protobuf:"bytes,10,opt,name=network,proto3" json:"network,omitempty"`
	...
	EnableEcrScanning bool `protobuf:"varint,11,opt,name=enable_ecr_scanning,json=enableEcrScanning,proto3" json:"enable_ecr_scanning,omitempty"`
	// cloudwatch_alarm contains the configuration for setting up cloudwatch on a cluster
	CloudwatchAlarm *CloudwatchAlarm `protobuf:"bytes,12,opt,name=cloudwatch_alarm,json=cloudwatchAlarm,proto3" json:"cloudwatch_alarm,omitempty"`
	// control_plane_cidr_allowlist is an optional list of CIDRs that are allowed to access the control plane
	ControlPlaneCidrAllowlist []string `protobuf:"bytes,13,rep,name=control_plane_cidr_allowlist,json=controlPlaneCidrAllowlist,proto3" json:"control_plane_cidr_allowlist,omitempty"`
}
...
func (x *EKS) GetNetwork() *AWSClusterNetwork {
	if x != nil {
		return x.Network
	}
	return nil
...
func (x *EKS) GetEnableEcrScanning() bool {
	if x != nil {
		return x.EnableEcrScanning
	}
	return false
}

func (x *EKS) GetCloudwatchAlarm() *CloudwatchAlarm {
	if x != nil {
		return x.CloudwatchAlarm
	}
	return nil
}

func (x *EKS) GetControlPlaneCidrAllowlist() []string {
	if x != nil {
		return x.ControlPlaneCidrAllowlist
	}
	return nil
}
...
func (x *CloudwatchAlarm) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloudwatchAlarm) ProtoMessage() {}

func (x *CloudwatchAlarm) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_eks_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloudwatchAlarm.ProtoReflect.Descriptor instead.
func (*CloudwatchAlarm) Descriptor() ([]byte, []int) {
	return file_porter_v1_eks_proto_rawDescGZIP(), []int{1}
}

func (x *CloudwatchAlarm) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
func (x *CloudwatchAlarm) GetEmails() []string {
	if x != nil {
		return x.Emails
	}
	return nil
...
func (x *AWSClusterNetwork) Reset() {
	*x = AWSClusterNetwork{}
	if protoimpl.UnsafeEnabled {
...
func (x *AWSClusterNetwork) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSClusterNetwork) ProtoMessage() {}

func (x *AWSClusterNetwork) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_eks_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSClusterNetwork.ProtoReflect.Descriptor instead.
func (*AWSClusterNetwork) Descriptor() ([]byte, []int) {
	return file_porter_v1_eks_proto_rawDescGZIP(), []int{2}
}

func (x *AWSClusterNetwork) GetVpcCidr() string {
	if x != nil {
		return x.VpcCidr
	}
	return ""
...
func (x *AWSClusterNetwork) GetServiceCidr() string {
	if x != nil {
...
type EKSNodeGroup struct {
	...
	AdditionalTaints []string `protobuf:"bytes,7,rep,name=additional_taints,json=additionalTaints,proto3" json:"additional_taints,omitempty"`
	// disk_size_gb is the size of the disk in GB for the node group instances. If unspecified, this will default to 50.
	DiskSizeGb uint32 `protobuf:"varint,8,opt,name=disk_size_gb,json=diskSizeGb,proto3" json:"disk_size_gb,omitempty"`
	...
	NodeGroupId string `protobuf:"bytes,9,opt,name=node_group_id,json=nodeGroupId,proto3" json:"node_group_id,omitempty"`
	...
	NodeGroupName string `protobuf:"bytes,10,opt,name=node_group_name,json=nodeGroupName,proto3" json:"node_group_name,omitempty"`
}
...
func (x *EKSNodeGroup) GetAdditionalTaints() []string {
	if x != nil {
...
func (x *EKSNodeGroup) GetDiskSizeGb() uint32 {
	if x != nil {
		return x.DiskSizeGb
	}
	return 0
...
func (x *EKSNodeGroup) GetNodeGroupId() string {
	if x != nil {
...
func (x *EKSNodeGroup) GetNodeGroupName() string {
	if x != nil {
...
type EKSLogging struct {
	...
	EnableCloudwatchLogsToS3 bool `protobuf:"varint,6,opt,name=enable_cloudwatch_logs_to_s3,json=enableCloudwatchLogsToS3,proto3" json:"enable_cloudwatch_logs_to_s3,omitempty"`
}

func (x *EKSLogging) Reset() {
	*x = EKSLogging{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_eks_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EKSLogging) Descriptor() ([]byte, []int) {
	return file_porter_v1_eks_proto_rawDescGZIP(), []int{5}
}
...
func (x *EKSLogging) GetEnableCloudwatchLogsToS3() bool {
	if x != nil {
		return x.EnableCloudwatchLogsToS3
	}
	return false
}
...
func (x *EKSPreflightValues) Reset() {
	*x = EKSPreflightValues{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_eks_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EKSPreflightValues) Descriptor() ([]byte, []int) {
	return file_porter_v1_eks_proto_rawDescGZIP(), []int{6}
}

func (x *EKSPreflightValues) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
type AWSVpc struct {
	...
	Subnets []*AWSSubnet `protobuf:"bytes,3,rep,name=subnets,proto3" json:"subnets,omitempty"`
}

func (x *AWSVpc) Reset() {
	*x = AWSVpc{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_eks_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AWSVpc) Descriptor() ([]byte, []int) {
	return file_porter_v1_eks_proto_rawDescGZIP(), []int{7}
}

func (x *AWSVpc) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AWSVpc) GetCidrRange() string {
	if x != nil {
		return x.CidrRange
	}
	return ""
...
func (x *AWSVpc) GetSubnets() []*AWSSubnet {
	if x != nil {
		return x.Subnets
	}
	return nil
...
func (x *AWSSubnet) Reset() {
	*x = AWSSubnet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_porter_v1_eks_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AWSSubnet) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSSubnet) ProtoMessage() {}

func (x *AWSSubnet) ProtoReflect() protoreflect.Message {
	mi := &file_porter_v1_eks_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSSubnet.ProtoReflect.Descriptor instead.
func (*AWSSubnet) Descriptor() ([]byte, []int) {
	return file_porter_v1_eks_proto_rawDescGZIP(), []int{8}
}

func (x *AWSSubnet) GetAvailabilityZone() string {
	if x != nil {
...
func (x *AWSSubnet) GetCidrRange() string {
	if x != nil {
		return x.CidrRange
	}
	return ""
...
var file_porter_v1_eks_proto_rawDesc = []byte{
	...
	0x22, 0x85, 0x05, 0x0a, 0x03, 0x45, 0x4b, 0x53, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6c, 0x75, 0x73,
	...
	,
	...
	0x54, 0x79, 0x70, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x6d, 0x69, 0x6e, 0x5f, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6d, 0x69, 0x6e,
	0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x6d, 0x61, 0x78,
	0x5f, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0c, 0x6d, 0x61, 0x78, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x12, 0x40,
	...
	,
	...
	,
	...
	0x63, 0x69, 0x64, 0x72, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x2e, 0x0a, 0x07, 0x73, 0x75, 0x62,
	0x6e, 0x65, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x6f, 0x72,
	0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x57, 0x53, 0x53, 0x75, 0x62, 0x6e, 0x65, 0x74,
	0x52, 0x07, 0x73, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x73, 0x22, 0x57, 0x0a, 0x09, 0x41, 0x57, 0x53,
	0x53, 0x75, 0x62, 0x6e, 0x65, 0x74, 0x12, 0x2b, 0x0a, 0x11, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61,
	...
	,
	...
	0x12, 0x1a, 0x0a, 0x16, 0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x42, 0x41, 0x4c, 0x41, 0x4e, 0x43, 0x45,
	0x52, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4e, 0x4c, 0x42, 0x10, 0x01, 0x12, 0x1a, 0x0a, 0x16,
	0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x42, 0x41, 0x4c, 0x41, 0x4e, 0x43, 0x45, 0x52, 0x5f, 0x54, 0x59,
	0x50, 0x45, 0x5f, 0x41, 0x4c, 0x42, 0x10, 0x02, 0x42, 0xa3, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d,
	0x2e, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x45, 0x6b, 0x73, 0x50,
...
var file_porter_v1_eks_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_porter_v1_eks_proto_goTypes = []any{
	(NodeGroupType)(0),         // 0: porter.v1.NodeGroupType
	(LoadBalancerType)(0),      // 1: porter.v1.LoadBalancerType
	(*EKS)(nil),                // 2: porter.v1.EKS
	(*CloudwatchAlarm)(nil),    // 3: porter.v1.CloudwatchAlarm
	(*AWSClusterNetwork)(nil),  // 4: porter.v1.AWSClusterNetwork
	(*EKSNodeGroup)(nil),       // 5: porter.v1.EKSNodeGroup
	(*LoadBalancer)(nil),       // 6: porter.v1.LoadBalancer
	(*EKSLogging)(nil),         // 7: porter.v1.EKSLogging
	(*EKSPreflightValues)(nil), // 8: porter.v1.EKSPreflightValues
	(*AWSVpc)(nil),             // 9: porter.v1.AWSVpc
	(*AWSSubnet)(nil),          // 10: porter.v1.AWSSubnet
	nil,                        // 11: porter.v1.LoadBalancer.TagsEntry
}
var file_porter_v1_eks_proto_depIdxs = []int32{
	5,  // 0: porter.v1.EKS.node_groups:type_name -> porter.v1.EKSNodeGroup
	6,  // 1: porter.v1.EKS.load_balancer:type_name -> porter.v1.LoadBalancer
	7,  // 2: porter.v1.EKS.logging:type_name -> porter.v1.EKSLogging
	4,  // 3: porter.v1.EKS.network:type_name -> porter.v1.AWSClusterNetwork
	3,  // 4: porter.v1.EKS.cloudwatch_alarm:type_name -> porter.v1.CloudwatchAlarm
	0,  // 5: porter.v1.EKSNodeGroup.node_group_type:type_name -> porter.v1.NodeGroupType
	1,  // 6: porter.v1.LoadBalancer.load_balancer_type:type_name -> porter.v1.LoadBalancerType
	11, // 7: porter.v1.LoadBalancer.tags:type_name -> porter.v1.LoadBalancer.TagsEntry
	10, // 8: porter.v1.AWSVpc.subnets:type_name -> porter.v1.AWSSubnet
...
func file_porter_v1_eks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_porter_v1_eks_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*EKS); i {
			case 0:
				return &v.state
			case 1:
		...
		file_porter_v1_eks_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CloudwatchAlarm); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_porter_v1_eks_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*AWSClusterNetwork); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_porter_v1_eks_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_porter_v1_eks_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_porter_v1_eks_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_porter_v1_eks_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_porter_v1_eks_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*AWSVpc); i {
			case 0:
				return &v.state
			case 1:
		...
		file_porter_v1_eks_proto_msgTypes[8].Exporter = func(v any, i int) any {
			switch v := v.(*AWSSubnet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
