...
func file_porter_v1_eks_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_porter_v1_eks_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_porter_v1_eks_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_porter_v1_eks_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AWSVpc); i {
			case 0:
				return &v.state
			case 1:
		...
		file_porter_v1_eks_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
